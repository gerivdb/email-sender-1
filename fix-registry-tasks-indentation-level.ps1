# Script pour corriger le niveau d'indentation des tâches de registre dans le document actif
...
try {
    ...
    # Lignes à corriger avec leur indentation correcte (un niveau de plus)
    $linesToFix = @(
        @{
            LineNumber = 493
