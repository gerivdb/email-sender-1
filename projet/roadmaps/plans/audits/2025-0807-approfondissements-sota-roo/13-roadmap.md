...
- [ ] Dashboard Grafana/Prometheus (dashboards/grafana-prometheus.json)
- [ ] Widget KPI (dashboards/widget-kpi.json)
- [ ] Rapport benchmark externe (audit/benchmark-externe.md)
...
- [ ] Template script par mode (scripts/templates/template-mode.sh)
...
- [ ] Procédure crise rollback/communication (docs/procedure-crise.md)
