...
powershell -ExecutionPolicy Bypass -File "development\scripts\Generate-PlanDevFromFile.ps1" -Version "%VERSION%" -Title "%TITLE%" -Description "%DESCRIPTION%" -Phases %PHASES%
