...
Anciens chemins:
D:\\DO\\WEB\\N8N_tests\\PROJETS\\EMAIL_SENDER_1 (avec espaces et underscores)
D:\\DO\\WEB\\N8N_tests\\PROJETS\\EMAIL_SENDER_1 (sans espaces)
D:\DO\WEB\N8N tests\scripts json à tester\EMAIL SENDER 1 (avec espaces et accents)
