...
| Fichier | Ligne | Colonne | SÃ©vÃ©ritÃ© | Message | RÃ¨gle | Source |
|---------|-------|---------|----------|---------|-------|--------|
| C:\Users\user\AppData\Local\Temp\pr-analysis-test\test-script-with-errors.ps1 | 3 | 0 | :warning: Warning | Variable potentiellement non initialisée | uninitialized-variable | ErrorPatternAnalyzer |
| C:\Users\user\AppData\Local\Temp\pr-analysis-test\test-script-with-errors.ps1 | 4 | 0 | :warning: Warning | Variable potentiellement non initialisée | uninitialized-variable | ErrorPatternAnalyzer |
| C:\Users\user\AppData\Local\Temp\pr-analysis-test\test-script-with-errors.ps1 | 4 | 0 | :warning: Warning | Référence potentiellement nulle | null-reference | ErrorPatternAnalyzer |
| C:\Users\user\AppData\Local\Temp\pr-analysis-test\test-script-with-errors.ps1 | 7 | 0 | :warning: Warning | Variable potentiellement non initialisée | uninitialized-variable | ErrorPatternAnalyzer |
| C:\Users\user\AppData\Local\Temp\pr-analysis-test\test-script-with-errors.ps1 | 8 | 0 | :warning: Warning | Variable potentiellement non initialisée | uninitialized-variable | ErrorPatternAnalyzer |
| C:\Users\user\AppData\Local\Temp\pr-analysis-test\test-script-with-errors.ps1 | 8 | 0 | :warning: Warning | Index potentiellement hors limites | index-out-of-bounds | ErrorPatternAnalyzer |
| C:\Users\user\AppData\Local\Temp\pr-analysis-test\test-script-with-errors.ps1 | 9 | 1 | :warning: Warning | The variable 'value' is assigned but never used. | PSUseDeclaredVarsMoreThanAssignments | PSScriptAnalyzer |
| C:\Users\user\AppData\Local\Temp\pr-analysis-test\test-script-with-errors.ps1 | 11 | 0 | :warning: Warning | Variable potentiellement non initialisée | uninitialized-variable | ErrorPatternAnalyzer |
| C:\Users\user\AppData\Local\Temp\pr-analysis-test\test-script-with-errors.ps1 | 12 | 0 | :warning: Warning | Variable potentiellement non initialisée | uninitialized-variable | ErrorPatternAnalyzer |
| C:\Users\user\AppData\Local\Temp\pr-analysis-test\test-script-with-errors.ps1 | 12 | 1 | :warning: Warning | The Variable 'input' is an automatic variable that is built into PowerShell, assigning to it might have undesired side effects. If assignment is not by design, please use a different name. | PSAvoidAssignmentToAutomaticVariable | PSScriptAnalyzer |
| C:\Users\user\AppData\Local\Temp\pr-analysis-test\test-script-with-errors.ps1 | 12 | 5 | :warning: Warning | Conversion de type potentiellement invalide | type-conversion | ErrorPatternAnalyzer |
| C:\Users\user\AppData\Local\Temp\pr-analysis-test\test-script-with-errors.ps1 | 13 | 1 | :warning: Warning | The variable 'number' is assigned but never used. | PSUseDeclaredVarsMoreThanAssignments | PSScriptAnalyzer |
| C:\Users\user\AppData\Local\Temp\pr-analysis-test\test-script-with-errors.ps1 | 15 | 0 | :warning: Warning | Variable potentiellement non initialisée | uninitialized-variable | ErrorPatternAnalyzer |
| C:\Users\user\AppData\Local\Temp\pr-analysis-test\test-script-with-errors.ps1 | 16 | 1 | :warning: Warning | The variable 'result' is assigned but never used. | PSUseDeclaredVarsMoreThanAssignments | PSScriptAnalyzer |
| C:\Users\user\AppData\Local\Temp\pr-analysis-test\test-script-with-errors.ps1 | 18 | 0 | :warning: Warning | Variable potentiellement non initialisée | uninitialized-variable | ErrorPatternAnalyzer |
| C:\Users\user\AppData\Local\Temp\pr-analysis-test\test-script-with-errors.ps1 | 19 | 0 | :warning: Warning | Variable potentiellement non initialisée | uninitialized-variable | ErrorPatternAnalyzer |
| C:\Users\user\AppData\Local\Temp\pr-analysis-test\test-script-with-errors.ps1 | 19 | 5 | :warning: Warning | Division potentielle par zéro | division-by-zero | ErrorPatternAnalyzer |
| C:\Users\user\AppData\Local\Temp\pr-analysis-test\test-script-with-errors.ps1 | 20 | 1 | :warning: Warning | The variable 'quotient' is assigned but never used. | PSUseDeclaredVarsMoreThanAssignments | PSScriptAnalyzer |
| C:\Users\user\AppData\Local\Temp\pr-analysis-test\test-script-with-errors.ps1 | 22 | 0 | :warning: Warning | Variable potentiellement non initialisée | uninitialized-variable | ErrorPatternAnalyzer |
| C:\Users\user\AppData\Local\Temp\pr-analysis-test\test-script-with-errors.ps1 | 23 | 0 | :warning: Warning | Référence potentiellement nulle | null-reference | ErrorPatternAnalyzer |
| C:\Users\user\AppData\Local\Temp\pr-analysis-test\test-script-with-errors.ps1 | 23 | 0 | :warning: Warning | Variable potentiellement non initialisée | uninitialized-variable | ErrorPatternAnalyzer |
| C:\Users\user\AppData\Local\Temp\pr-analysis-test\test-script-with-errors.ps1 | 28 | 0 | :warning: Warning | Variable potentiellement non initialisée | uninitialized-variable | ErrorPatternAnalyzer |
| C:\Users\user\AppData\Local\Temp\pr-analysis-test\test-script-with-errors.ps1 | 29 | 0 | :warning: Warning | Variable potentiellement non initialisée | uninitialized-variable | ErrorPatternAnalyzer |
| C:\Users\user\AppData\Local\Temp\pr-analysis-test\test-script-with-errors.ps1 | 29 | 8 | :warning: Warning | Conversion de type potentiellement invalide | type-conversion | ErrorPatternAnalyzer |
| C:\Users\user\AppData\Local\Temp\pr-analysis-test\test-script-with-errors.ps1 | 31 | 0 | :warning: Warning | Variable potentiellement non initialisée | uninitialized-variable | ErrorPatternAnalyzer |
| C:\Users\user\AppData\Local\Temp\pr-analysis-test\test-script-without-errors.ps1 | 3 | 0 | :warning: Warning | Variable potentiellement non initialisée | uninitialized-variable | ErrorPatternAnalyzer |
| C:\Users\user\AppData\Local\Temp\pr-analysis-test\test-script-without-errors.ps1 | 4 | 0 | :warning: Warning | Variable potentiellement non initialisée | uninitialized-variable | ErrorPatternAnalyzer |
| C:\Users\user\AppData\Local\Temp\pr-analysis-test\test-script-without-errors.ps1 | 5 | 0 | :warning: Warning | Variable potentiellement non initialisée | uninitialized-variable | ErrorPatternAnalyzer |
...
| C:\Users\user\AppData\Local\Temp\pr-analysis-test\test-script-without-errors.ps1 | 42 | 0 | :warning: Warning | Référence potentiellement nulle | null-reference | ErrorPatternAnalyzer |
