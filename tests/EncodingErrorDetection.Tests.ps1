BeforeAll {
    ...
    $global:scriptPath = Join-Path -Path $PSScriptRoot -ChildPath "..\scripts\maintenance\encoding\Detect-VariableReferences.ps1"
...
$message = "Bonjour $username, voici un texte accentué avec $variable"
Write-Host "Le résultat accentué est: $result"
'@
