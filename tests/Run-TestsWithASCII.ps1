...
# Executer les tests
Invoke-EncodedTest -TestScript ".\tests\Basic-ErrorPatternAnalyzer.Tests.ps1"
Invoke-EncodedTest -TestScript ".\tests\test_predict_cascades.ps1"
Invoke-EncodedTest -TestScript ".\tests\test_integrate_omnibus_direct.ps1"
