...
BeforeAll {
    ...
    $agentAutoScriptPath = Join-Path -Path $PSScriptRoot -ChildPath "..\..\scripts\agent-auto\Example-AgentAutoSegmentation.ps1"
...
"@ | Out-File -FilePath $agentAutoScriptPath -Encoding utf8
    ...
    $initScriptPath = Join-Path -Path $PSScriptRoot -ChildPath "..\..\scripts\agent-auto\Initialize-AgentAutoSegmentation.ps1"
