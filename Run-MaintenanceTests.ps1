...
.DESCRIPTION
    ...
    des scripts de maintenance. Il appelle le script Run-TestSuite.ps1 dans le dossier
    development/scripts/maintenance/test/.
...
.EXAMPLE
    .\Run-MaintenanceTests.ps1 -OutputPath ".\reports" -GenerateHTML
.EXAMPLE
    .\Run-MaintenanceTests.ps1 -TestType Unit -OutputPath ".\reports\tests"
.NOTES
    Version: 1.0.0
...
$testDir = Join-Path -Path $PSScriptRoot -ChildPath "development\scripts\maintenance\test"
