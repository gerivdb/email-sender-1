...
async function setupGitingestMcp() {
  try {
    ...
    // Vérifier si le package @modelcontextprotocol/server est installé
    try {
      require('@modelcontextprotocol/server');
      console.log('Le package @modelcontextprotocol/server est déjà installé.');
    } catch (error) {
      console.log('Installation du package @modelcontextprotocol/server...');
      execSync('npm install -g @modelcontextprotocol/server', { stdio: 'inherit' });
