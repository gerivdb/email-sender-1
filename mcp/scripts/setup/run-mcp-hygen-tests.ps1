<#
.SYNOPSIS
    Script d'exécution des tests unitaires pour les templates Hygen MCP.

.DESCRIPTION
    Ce script exécute les tests unitaires pour les templates Hygen MCP.

.PARAMETER OutputPath
    Chemin du fichier de rapport de tests. Par défaut, "mcp\docs\hygen-test-report.md".

.EXAMPLE
    .\run-mcp-hygen-tests.ps1
    Exécute les tests unitaires et génère un rapport dans le chemin par défaut.

.EXAMPLE
    .\run-mcp-hygen-tests.ps1 -OutputPath "C:\Temp\test-report.md"
