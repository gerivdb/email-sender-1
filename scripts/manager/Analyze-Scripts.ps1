...
.PARAMETER InventoryPath
    Chemin du fichier d'inventaire (par défaut : scripts\manager\data\inventory.json)
.PARAMETER OutputPath
    Chemin du fichier de sortie (par défaut : scripts\manager\data\analysis.json)
.PARAMETER Verbose
...
param (
    ...
    [string]$OutputPath = "scripts\manager\data\analysis.json"
)
