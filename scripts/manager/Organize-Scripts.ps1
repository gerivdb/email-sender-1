...
.PARAMETER AnalysisPath
    Chemin du fichier d'analyse (par défaut : scripts\manager\data\analysis.json)
.PARAMETER AutoApply
...
param (
    [string]$AnalysisPath = "scripts\manager\data\analysis.json",
    [switch]$AutoApply
)
...
$OutputPath = "scripts\manager\data\organization.json"
