...
try {
    ...
    # Demander confirmation avant de supprimer tous les workflows
    Write-Host "ATTENTION: Vous Ãªtes sur le point de supprimer tous les workflows existants dans n8n." -ForegroundColor Red
    Write-Host "Cette action est irrÃ©versible." -ForegroundColor Red
    $confirmation = Read-Host "ÃŠtes-vous sÃ»r de vouloir continuer? (O/N)"
