...
$mcpStandardPath = ".\src\mcp\batch\mcp-standard.cmd"
$mcpNotionPath = ".\src\mcp\batch\mcp-notion.cmd"
$gatewayPath = ".\src\mcp\batch\gateway.exe.cmd"
...
Write-Host "✅ Tous les fichiers batch necessaires existent" -ForegroundColor Green
...
Write-Host "✅ Fichiers d'identifiants crees" -ForegroundColor Green
