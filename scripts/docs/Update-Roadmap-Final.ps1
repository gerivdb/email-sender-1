# Update-Roadmap-Final.ps1
# Script final pour mettre à jour la roadmap personnelle
...
# Sauvegarder le fichier Markdown avec encodage UTF8
$markdown | Out-File -FilePath $roadmapPath -Encoding utf8
