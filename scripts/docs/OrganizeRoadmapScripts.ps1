...
Cela lancera l'exécution automatique de la roadmap avec les 
...
```powershell
.\StartRoadmapExecution.ps1 -RoadmapPath ""Roadmap\roadmap_perso.md"" -AutoExecute -AutoUpdate -MaxRetries 5 -RetryDelay 10
```
"@
