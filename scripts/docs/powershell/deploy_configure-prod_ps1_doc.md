# Documentation PowerShell pour deploy\configure-prod.ps1
...
Source: deploy\configure-prod.ps1
Fichier de sortie: docs\powershell\deploy_configure-prod_ps1_doc.md
# Documentation PowerShell pour deploy\configure-prod.ps1
