...
$testFile = Join-Path -Path $PSScriptRoot -ChildPath "Tests\ErrorLearningSystem.Integration.Simplified.ps1"

# Afficher les tests trouvés
Write-Host "Test d'intégration simplifié trouvé :" -ForegroundColor Cyan
Write-Host "  ErrorLearningSystem.Integration.Simplified.ps1" -ForegroundColor Yellow
