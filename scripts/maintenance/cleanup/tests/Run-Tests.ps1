...
<#
.SYNOPSIS
    Exécute les tests unitaires pour Repair-PSScriptAnalyzerIssues.ps1.
.DESCRIPTION
    Ce script importe correctement le script principal et exécute les tests unitaires.
.NOTES
...
# Importer les fonctions du script à tester
. $scriptPath
