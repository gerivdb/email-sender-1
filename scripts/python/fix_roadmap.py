...
"""
Script pour corriger les problèmes dans format_roadmap_text.py
"""

# Correction de la fonction get_indentation_level
get_indentation_level_fix = """def get_indentation_level(line: str) -> int:
...
# Correction de la fonction format_line_by_indentation
format_line_by_indentation_fix = """def format_line_by_indentation(line: str, level: int) -> str:
...
# Correction de la fonction format_text_to_roadmap
format_text_to_roadmap_fix = """def format_text_to_roadmap(input_text: str, section_title: str, complexity: str, time_estimate: str) -> str:
...
# Correction de la fonction insert_section_in_roadmap
insert_section_in_roadmap_fix = """def insert_section_in_roadmap(roadmap_path: str, section_content: str, section_number: int, dry_run: bool = False) -> bool:
...
# Écrire les correctifs dans un fichier
with open('format_roadmap_text_fixed.py', 'w', encoding='utf-8') as f:
...
""")
    ...
    # Ajouter les fonctions corrigées
    f.write(get_indentation_level_fix + "\n\n\n")
    f.write("def is_phase_title(line: str) -> bool:\n")
    f.write("    \"\"\"Détermine si une ligne est un titre de phase.\"\"\"\n")
    f.write("    # Un titre de phase est généralement en majuscules, contient \"Phase\" ou est numéroté\n")
    f.write("    return (re.match(r\"^(PHASE|Phase|\\d+\\.|\\*\\*)\", line) or\n")
    f.write("            re.match(r\"^[A-Z][A-Z\\s]+$\", line))\n\n\n")
    f.write(format_line_by_indentation_fix + "\n\n\n")
    f.write(format_text_to_roadmap_fix + "\n\n\n")
    f.write(insert_section_in_roadmap_fix + "\n\n\n")
...
print("Fichier format_roadmap_text_fixed.py créé avec succès.")
