    ...
    journal_tasks = [
        {
            ...
            "type": "shell",
            "command": "python ${workspaceFolder}/scripts/python/journal/journal_vscode.py new",
            "problemMatcher": []
        },
        {
            "label": "Journal: Rechercher",
            "type": "shell",
            "command": "python ${workspaceFolder}/scripts/python/journal/journal_vscode.py search",
            "problemMatcher": []
        },
        {
            "label": "Journal: Reconstruire l'index",
            "type": "shell",
            "command": "python ${workspaceFolder}/scripts/python/journal/journal_search.py --rebuild",
            "problemMatcher": []
        }
    ]
