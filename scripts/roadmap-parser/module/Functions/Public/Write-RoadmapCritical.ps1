<#
.SYNOPSIS
    Écrit un message critique dans le journal du module RoadmapParser.

.DESCRIPTION
    La fonction Write-RoadmapCritical écrit un message critique dans le journal du module RoadmapParser.
