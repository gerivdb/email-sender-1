...
function Show-CycleGraph {
    ...
    $htmlPath = Export-CycleVisualizationHTML -CycleData $CycleData -HighlightCycles:$HighlightCycles -IncludeStatistics:$IncludeStatistics -OutputPath $OutputPath -OpenInBrowser
