...
.DESCRIPTION
    Cet adaptateur permet d'exécuter les tests de gestion des compteurs de performance
...
function Invoke-PerformanceCounterManagerTests {
    ...
    # Exécuter les tests
    Write-Host "Exécution des tests de gestion des compteurs de performance..." -ForegroundColor Cyan
