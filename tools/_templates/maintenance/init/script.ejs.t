<#
---
to: D:/DO/WEB/N8N_tests/PROJETS/EMAIL_SENDER_1/scripts/maintenance/init-maintenance.ps1
---
<#
.SYNOPSIS
    Initialise la structure de maintenance pour le projet <%= projectName %>.
...
$readmeContent = @"
# Scripts de maintenance pour <%= projectName %>

Ce répertoire contient des scripts pour la maintenance du projet <%= projectName %>.
