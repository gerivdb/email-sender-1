...
```powershell
.\tools\roadmap\task-detection\Integrate-TaskDetection.ps1
```

4. Vérifiez que l'installation s'est bien déroulée :

```powershell
.\tools\roadmap\task-detection\Test-TaskDetection.ps1 -InputText "<task category=\"1\">Test</task>"
```
...
```powershell
.\tools\roadmap\task-detection\Watch-Conversations.ps1 -ConversationsFolder "chemin/vers/dossier"
```
...
```powershell
.\tools\roadmap\task-detection\Watch-Conversations.ps1 -AddToRoadmap
```
...
```powershell
.\tools\roadmap\task-detection\Process-Conversation.ps1 -ConversationFile "chemin/vers/conversation.txt" -AddToRoadmap
```
...
```powershell
.\tools\roadmap\task-detection\Confirm-Tasks.ps1
```
...
```powershell
.\tools\roadmap\task-detection\Show-TaskLogs.ps1
```

Pour voir uniquement les dernières entrées :

```powershell
.\tools\roadmap\task-detection\Show-TaskLogs.ps1 -LastEntries 10
```

Pour exporter les journaux au format CSV :

```powershell
.\tools\roadmap\task-detection\Show-TaskLogs.ps1 -Export
```
...
```powershell
.\tools\roadmap\task-detection\Run-Tests.ps1
```
...
```powershell
.\tools\roadmap\task-detection\Optimize-Prompt.ps1
```

Pour appliquer automatiquement les optimisations :

```powershell
.\tools\roadmap\task-detection\Optimize-Prompt.ps1 -ApplyChanges
```
...
```powershell
.\tools\roadmap\task-detection\Optimize-Performance.ps1
```
...
```powershell
.\tools\roadmap\task-detection\Show-TaskLogs.ps1 -Clear
```
