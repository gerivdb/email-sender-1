...
& $addTask $task1
& $addTask $task1_1 $task1
& $addTask $task1_2 $task1
& $addTask $task1_2_1 $task1_2
& $addTask $task1_2_2 $task1_2
& $addTask $task2
& $addTask $task2_1 $task2

# Ajouter des dépendances
Write-Host "Ajout des dépendances..." -ForegroundColor Cyan
$addDependency1 = $task2.AddDependency
$addDependency2 = $task2_1.AddDependency
& $addDependency1 $task1
& $addDependency2 $task1_2_2
...
$importedTasks = & $importedTraverseDepthFirst
...
$completedTasks = & $filterTasks { param($t) $t.Status -eq [TaskStatus]::Complete }
...
$inProgressTasks = & $filterTasks { param($t) $t.Status -eq [TaskStatus]::InProgress }
