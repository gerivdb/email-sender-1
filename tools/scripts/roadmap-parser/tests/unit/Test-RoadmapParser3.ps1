...
$scriptPath = Join-Path -Path $PSScriptRoot -ChildPath "RoadmapParser3.ps1"
Write-Host "Script path: $scriptPath"
Write-Host "Script exists: $(Test-Path -Path $scriptPath)"

# Sourcer le script pour charger les fonctions
. $scriptPath
...
Ceci est une roadmap de test pour valider le script RoadmapParser3.ps1.
