...
Les scripts d'automatisation sont des scripts PowerShell qui automatisent des t̢ches. Ils sont stock̩s dans le dossier `scripts/automation/`.
...
Les scripts d'analyse sont des scripts PowerShell qui analysent des donn̩es. Ils sont stock̩s dans le dossier `scripts/analysis/`.
...
Les scripts de test sont des scripts PowerShell qui testent d'autres scripts. Ils sont stock̩s dans le dossier `scripts/tests/`.
...
Les scripts d'int̩gration sont des scripts PowerShell qui int̬grent diff̩rents syst̬mes. Ils sont stock̩s dans le dossier `scripts/integration/`.
...
- Scripts d'int̩gration : `scripts/integration/`
