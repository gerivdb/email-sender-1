...
function Export-RoadmapTreeToJson {
    ...
    try {
        ...
        throw "Erreur lors de l'ecriture du fichier JSON: $_"
    }
}
...
function Export-RoadmapTreeToMarkdown {
    ...
    try {
        ...
        throw "Erreur lors de l'ecriture du fichier Markdown: $_"
    }
}
...
function Import-RoadmapTreeFromJson {
    ...
    try {
        ...
        throw "Erreur lors de la lecture du fichier JSON: $_"
    }
...
function New-RoadmapReport {
    ...
    if (-not [string]::IsNullOrEmpty($FilePath)) {
        try {
            ...
            throw "Erreur lors de l'ecriture du fichier de rapport: $_"
        }
    }
...
function New-RoadmapVisualization {
    ...
    if (-not [string]::IsNullOrEmpty($FilePath)) {
        try {
            ...
            Write-Error "Get-Error writing visualization file: $_"
        }
    }
