...
#
# Script pour tester les fonctions publiques de comptage d'opérations
#
...
Write-Host "Début des tests des fonctions publiques de comptage d'opérations..." -ForegroundColor Cyan
...
Write-Host "`nTests des fonctions publiques de comptage d'opérations terminés." -ForegroundColor Cyan
