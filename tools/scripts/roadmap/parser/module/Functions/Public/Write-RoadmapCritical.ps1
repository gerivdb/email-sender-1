<#
.SYNOPSIS
    Ã‰crit un message critique dans le journal du module RoadmapParser.

.DESCRIPTION
    La fonction Write-RoadmapCritical Ã©crit un message critique dans le journal du module RoadmapParser.
    Elle est un wrapper autour de Write-RoadmapLog avec le niveau de journalisation Critical.
...
.EXAMPLE
    Write-RoadmapCritical -Message "Ceci est un message critique"
...
#>
function Write-RoadmapCritical {
    [CmdletBinding()]
    [OutputType([string])]
    param (
