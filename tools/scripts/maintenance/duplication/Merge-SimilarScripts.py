...
DEFAULT_INPUT_PATH = "scripts/manager/data/duplication_report.json"
DEFAULT_OUTPUT_PATH = "scripts/manager/data/merge_report.json"
DEFAULT_LIBRARY_PATH = "scripts/common/lib"
...
def write_log(message, level="INFO"):
    ...
    log_file = "scripts/manager/data/script_merge.log"
