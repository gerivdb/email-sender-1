# Module de visualisation des cycles de dependances
...
function Show-CycleGraph {
    ...
    $htmlPath = Export-CycleVisualization -CycleData $CycleData -HighlightCycles:$HighlightCycles -IncludeStatistics:$IncludeStatistics -OutputPath $OutputPath -OpenInBrowser
