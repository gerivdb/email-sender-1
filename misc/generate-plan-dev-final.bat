...
powershell -ExecutionPolicy Bypass -File "development\scripts\Generate-PlanDevFinal.ps1" -Version "%VERSION%" -Title "%TITLE%" -Description "%DESCRIPTION%" -Phases %PHASES%
