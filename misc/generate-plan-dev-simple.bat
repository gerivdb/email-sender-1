...
powershell -ExecutionPolicy Bypass -File "development\scripts\Generate-PlanDevSimple.ps1" -Version "%VERSION%" -Title "%TITLE%" -Description "%DESCRIPTION%" -Phases %PHASES%
