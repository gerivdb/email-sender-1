...
- [x] **Sous-tâche 3.4**: Créer des tests unitaires complets (3h)
  ...
  - **Fichier**: `tests/unit/CycleDetector.Tests.ps1`
...
- [x] **Sous-tâche 3.5**: Exécuter les tests et corriger les problèmes (1h)
  ...
  - **Fichier**: `docs/test_reports/CycleDetector_TestReport.md`
  - **Outils**: Pester, PowerShell
  - **Statut**: Terminé
- [ ] **Sous-tâche 3.6**: Documenter le module (1h)
  ...
  - **Fichier**: `docs/technical/CycleDetectorAPI.md`
...
| `tests/integration/CycleDetector_Integration.Tests.ps1` | Tests d'intégration | À créer |
...
- [ ] **Sous-tâche 2.2**: Exécuter les tests d'intégration (2h)
  ...
  - **Livrable**: Rapport d'exécution des tests
  - **Fichier**: `docs/test_reports/CycleDetector_Integration_TestReport.md`
  - **Outils**: Pester, PowerShell
  - **Statut**: Non commencé
