...
Set-Content -Path "$roadmapFolder\README.md" -Value $readmeContent -Encoding UTF8
Write-Host "Fichier README créé : $roadmapFolder\README.md" -ForegroundColor Green
