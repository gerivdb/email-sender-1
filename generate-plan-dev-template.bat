...
powershell -ExecutionPolicy Bypass -File "development\scripts\Generate-PlanDevFromTemplate.ps1" -Version "%VERSION%" -Title "%TITLE%" -Description "%DESCRIPTION%" -Phases %PHASES%
