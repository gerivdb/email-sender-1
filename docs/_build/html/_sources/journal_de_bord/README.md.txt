...
```bash
python scripts/python/journal/journal_entry.py --search "votre recherche"
```
...
```bash
python scripts/python/journal/journal_rag_simple.py --query "votre question"
```
...
```bash
python scripts/python/journal/run_semantic_analysis.py --all
```

Ou pour des analyses spécifiques:

```bash
python scripts/python/journal/semantic_analysis/embeddings.py --generate
python scripts/python/journal/semantic_analysis/sentiment_analysis.py --analyze
python scripts/python/journal/semantic_analysis/topic_modeling.py --model lda
```
...
```bash
python scripts/python/journal/run_integrations.py --all
```
...
```bash
# Notion
python scripts/python/journal/run_integrations.py --notion --notion-action sync-to-journal

# Jira
python scripts/python/journal/run_integrations.py --jira --jira-action sync-to-journal

# n8n
python scripts/python/journal/run_integrations.py --n8n --n8n-action create-workflows
```
...
```bash
python scripts/python/journal/integrations/n8n_integration.py --create-workflows
python scripts/python/journal/integrations/n8n_integration.py --activate-workflows
```
