Help on module test_create_update:

NAME
    test_create_update - Tests pour le module de création et mise à jour thématique.

CLASSES
    unittest.case.TestCase(builtins.object)
        TestThematicCreateUpdate

    class TestThematicCreateUpdate(unittest.case.TestCase)
     |  TestThematicCreateUpdate(methodName='runTest')
     |
     ...
     |      Skip this test.
     |
     |  subTest(self, msg=<object object at 0x0000023FAF818860>, **params)
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\src\orchestrator\tests\test_create_update.py
