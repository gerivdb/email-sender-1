Help on module test_hierarchical_themes:

NAME
    test_hierarchical_themes - Tests pour le module de gestion des thèmes hiérarchiques.

CLASSES
    unittest.case.TestCase(builtins.object)
        TestHierarchicalThemeManager

    class TestHierarchicalThemeManager(unittest.case.TestCase)
     |  TestHierarchicalThemeManager(methodName='runTest')
     |
     ...
     |      Skip this test.
     |
     |  subTest(self, msg=<object object at 0x0000021A30E08860>, **params)
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\src\orchestrator\tests\test_hierarchical_themes.py
