Help on module request:

NAME
    request - Module pour la gestion des requêtes MCP.
...
CLASSES
    ...
    class ExecuteToolParams(MCPRequestParams)
     |  ExecuteToolParams(*, name: str, arguments: Dict[str, Any] = <factory>) -> None
     |
     ...
     |
     |  __annotations__ = {'arguments': typing.Dict[str, typing.Any], 'name': ...
     |
     |  __class_vars__ = set()
     |
     ...
     |
     |  __pydantic_core_schema__ = {'cls': <class 'request.ExecuteToolParams'>...
     |
     |  __pydantic_custom_init__ = False
     |
     |  __pydantic_decorators__ = DecoratorInfos(validators={}, field_validato...
     |
     |  __pydantic_fields__ = {'arguments': FieldInfo(annotation=Dict[str, Any...
     |
     ...
     |
     |  __pydantic_validator__ = SchemaValidator(title="ExecuteToolParams", va...
     |
     |  __signature__ = <Signature (*, name: str, arguments: Dict[str, Any] = ...
     |
     |  model_config = {}
     |
     |  ----------------------------------------------------------------------
     |  Data descriptors inherited from MCPRequestParams:
     |
     |  __weakref__
     ...
     |
     |  model_fields = {'arguments': FieldInfo(annotation=Dict[str, Any], requ...

    class GetSchemaParams(MCPRequestParams)
     |  GetSchemaParams(*, name: str) -> None
     |
     ...
     |  __pydantic_computed_fields__ = {}
     |
     |  __pydantic_core_schema__ = {'cls': <class 'request.GetSchemaParams'>, ...
     |
     |  __pydantic_custom_init__ = False
     |
     |  __pydantic_decorators__ = DecoratorInfos(validators={}, field_validato...
     ...
     |  __pydantic_setattr_handlers__ = {}
     |
     |  __pydantic_validator__ = SchemaValidator(title="GetSchemaParams", vali...
     |
     ...
     |  model_computed_fields = {}
     |
     |  model_fields = {'name': FieldInfo(annotation=str, required=True, descr...

    class GetStatusParams(MCPRequestParams)
     |  GetStatusParams() -> None
     |
     ...
     |  __pydantic_computed_fields__ = {}
     |
     |  __pydantic_core_schema__ = {'cls': <class 'request.GetStatusParams'>, ...
     |
     |  __pydantic_custom_init__ = False
     |
     |  __pydantic_decorators__ = DecoratorInfos(validators={}, field_validato...
     ...
     |  __pydantic_setattr_handlers__ = {}
     |
     |  __pydantic_validator__ = SchemaValidator(title="GetStatusParams", vali...
     |
    ...
    class ListToolsParams(MCPRequestParams)
     ...
     |  __pydantic_computed_fields__ = {}
     |
     |  __pydantic_core_schema__ = {'cls': <class 'request.ListToolsParams'>, ...
     |
     |  __pydantic_custom_init__ = False
     |
     |  __pydantic_decorators__ = DecoratorInfos(validators={}, field_validato...
     ...
     |  __pydantic_setattr_handlers__ = {}
     |
     |  __pydantic_validator__ = SchemaValidator(title="ListToolsParams", vali...
     |
     |  __signature__ = <Signature () -> None>
     |
     |  model_config = {}
    ...
    class MCPRequest(pydantic.main.BaseModel)
     |  MCPRequest(*, jsonrpc: str = '2.0', id: str, method: str, params: Optional[Dict[str, Any]] = None) -> None
     |
     ...
     |
     |  validate_params(self) -> Dict[str, Any]
     ...
     |
     |  from_json(json_str: str) -> 'MCPRequest'
     ...
     |  __abstractmethods__ = frozenset()
     |
     |  __annotations__ = {'id': <class 'str'>, 'jsonrpc': <class 'str'>, 'met...
     |
     |  __class_vars__ = set()
     |
     |  __private_attributes__ = {}
     ...
     |  __pydantic_computed_fields__ = {}
     |
     |  __pydantic_core_schema__ = {'cls': <class 'request.MCPRequest'>, 'conf...
     |
     |  __pydantic_custom_init__ = False
     |
     |  __pydantic_decorators__ = DecoratorInfos(validators={}, field_validato...
     ...
     |  __pydantic_setattr_handlers__ = {}
     |
     |  __pydantic_validator__ = SchemaValidator(title="MCPRequest", validator...
     |
     |  __signature__ = <Signature (*, jsonrpc: str = '2.0', id: str, me...par...
     |
     |  model_config = {}
     |
     |  ----------------------------------------------------------------------
     ...
     |  model_computed_fields = {}
     |
     |  model_fields = {'id': FieldInfo(annotation=str, required=True, descrip...

    class MCPRequestParams(pydantic.main.BaseModel)
     |  MCPRequestParams() -> None
     |
     ...
     |  __pydantic_computed_fields__ = {}
     |
     |  __pydantic_core_schema__ = {'cls': <class 'request.MCPRequestParams'>,...
     |
     |  __pydantic_custom_init__ = False
     |
     |  __pydantic_decorators__ = DecoratorInfos(validators={}, field_validato...
     ...
     |  __pydantic_setattr_handlers__ = {}
     |
     |  __pydantic_validator__ = SchemaValidator(title="MCPRequestParams", val...
     |
     |  __signature__ = <Signature () -> None>
     |
     |  model_config = {}
...
DATA
    ...
    logger = <Logger mcp.core.request (INFO)>

FILE
    d:\do\web\n8n_tests\projets\email_sender_1\src\mcp\core\mcp\request.py
