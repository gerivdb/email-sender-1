...
CLASSES
    ...
    class PineconeConfig(pydantic.main.BaseModel)
     |  PineconeConfig(*, collection_name: str = 'mem0', embedding_model_dims: int = 1536, client: Optional[Any] = None, api_key: Optional[str] = None, environment: Optional[str] = None, serverless_config: Optional[Dict[str, Any]] = None, pod_config: Optional[Dict[str, Any]] = None, hybrid_search: bool = False, metric: str = 'cosine', batch_size: int = 100, extra_params: Optional[Dict[str, Any]] = None) -> None
     |
     ...
     |
     |  check_api_key_or_client(values: Dict[str, Any]) -> Dict[str, Any]
     |
     |  check_pod_or_serverless(values: Dict[str, Any]) -> Dict[str, Any]
     |
     ...
     |
     |  __annotations__ = {'api_key': typing.Optional[str], 'batch_size': <cla...
     |
     |  __class_vars__ = set()
     |
     ...
     |
     |  __pydantic_core_schema__ = {'cls': <class 'pinecone.PineconeConfig'>, ...
     |
     ...
     |
     |  __pydantic_validator__ = SchemaValidator(title="PineconeConfig", valid...
     |
     |  __signature__ = <Signature (*, collection_name: str = 'mem0', em...par...
     |
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\mem0-analysis\repo\mem0\configs\vector_stores\pinecone.py
