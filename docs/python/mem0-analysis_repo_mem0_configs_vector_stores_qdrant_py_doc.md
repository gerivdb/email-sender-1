...
CLASSES
    ...
    class QdrantConfig(pydantic.main.BaseModel)
     |  QdrantConfig(*, collection_name: str = 'mem0', embedding_model_dims: Optional[int] = 1536, client: Optional[qdrant_client.qdrant_client.QdrantClient] = None, host: Optional[str] = None, port: Optional[int] = None, path: Optional[str] = '/tmp/qdrant', url: Optional[str] = None, api_key: Optional[str] = None, on_disk: Optional[bool] = False) -> None
     |
     ...
     |
     |  check_host_port_or_path(values: Dict[str, Any]) -> Dict[str, Any]
     |
     ...
     |
     |  __annotations__ = {'QdrantClient': typing.ClassVar[type], 'api_key': t...
     |
     |  __class_vars__ = {'QdrantClient'}
     |
     ...
     |
     |  __pydantic_core_schema__ = {'cls': <class 'qdrant.QdrantConfig'>, 'con...
     |
     ...
     |
     |  __pydantic_validator__ = SchemaValidator(title="QdrantConfig", validat...
     |
     |  __signature__ = <Signature (*, collection_name: str = 'mem0', em...= N...
     |
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\mem0-analysis\repo\mem0\configs\vector_stores\qdrant.py
