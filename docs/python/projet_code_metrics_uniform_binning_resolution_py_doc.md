Help on module uniform_binning_resolution:

NAME
    uniform_binning_resolution - Module pour l'évaluation de la résolution avec binning uniforme.

FUNCTIONS
    evaluate_uniform_binning_resolution(data: numpy.ndarray, min_bins: int = 5, max_bins: int = 100, step: int = 5, theoretical_params: Optional[Dict[str, float]] = None) -> Dict[str, Any]
    ...
    plot_uniform_binning_resolution_evaluation(evaluation_results: Dict[str, Any], save_path: Optional[str] = None, show_plot: bool = True) -> None
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\projet\code\metrics\uniform_binning_resolution.py
