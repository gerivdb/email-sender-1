...
CLASSES
    ...
    class TestMemoryManager(unittest.case.TestCase)
     ...
     |      Skip this test.
     |
     |  subTest(self, msg=<object object at 0x0000020B96D98860>, **params)
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\src\mcp\tests\memory\test_memory_manager.py
