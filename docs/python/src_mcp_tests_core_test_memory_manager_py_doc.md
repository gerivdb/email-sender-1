Help on module test_memory_manager:
...
CLASSES
    ...
    class TestMemory(unittest.case.TestCase)
     |  TestMemory(methodName='runTest')
     |
     ...
     |      Skip this test.
     |
     |  subTest(self, msg=<object object at 0x0000022822198860>, **params)
    ...
    class TestMemoryManager(unittest.case.TestCase)
     |  TestMemoryManager(methodName='runTest')
     |
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\src\mcp\tests\core\test_memory_manager.py
