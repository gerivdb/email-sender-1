...
CLASSES
    ...
    class TestMCPCore(unittest.case.TestCase)
     |  TestMCPCore(methodName='runTest')
     |
     ...
     |      Skip this test.
     |
     |  subTest(self, msg=<object object at 0x000002465EDF8860>, **params)
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\src\mcp\tests\core\test_mcp_core.py
