Help on module vertex_ai_vector_search:
...
CLASSES
    ...
    class GoogleMatchingEngineConfig(pydantic.main.BaseModel)
     |  GoogleMatchingEngineConfig(*, project_id: str, project_number: str, region: str, endpoint_id: str, index_id: str, deployment_index_id: str, collection_name: Optional[str] = None, credentials_path: Optional[str] = None, vector_search_api_endpoint: Optional[str] = None) -> None
     |
     ...
     |
     |  model_post_init(self, _context) -> None
     ...
     |
     |  __annotations__ = {'collection_name': typing.Optional[str], 'credentia...
     |
     |  __class_vars__ = set()
     |
     ...
     |
     |  __pydantic_core_schema__ = {'cls': <class 'vertex_ai_vector_search.Goo...
     |
     |  __pydantic_custom_init__ = True
     |
     |  __pydantic_decorators__ = DecoratorInfos(validators={}, field_validato...
     |
     |  __pydantic_fields__ = {'collection_name': FieldInfo(annotation=Union[s...
     |
     ...
     |
     |  __pydantic_validator__ = SchemaValidator(title="GoogleMatchingEngineCo...
     |
     |  __signature__ = <Signature (*, project_id: str, project_number: ...arc...
     |
     ...
     |
     |  model_fields = {'collection_name': FieldInfo(annotation=Union[str, Non...
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\mem0-analysis\repo\mem0\configs\vector_stores\vertex_ai_vector_search.py
