Help on module test_document_manager:
...
CLASSES
    ...
    class TestDocumentManager(unittest.case.TestCase)
     |  TestDocumentManager(methodName='runTest')
     |
     ...
     |      Skip this test.
     |
     |  subTest(self, msg=<object object at 0x00000252C44D8860>, **params)
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\src\mcp\tests\document\test_document_manager.py
