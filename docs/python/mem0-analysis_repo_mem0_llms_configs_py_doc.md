...
CLASSES
    ...
    class LlmConfig(pydantic.main.BaseModel)
     |  LlmConfig(*, provider: str = 'openai', config: Optional[dict] = {}) -> None
     |
     ...
     |
     |  __pydantic_core_schema__ = {'cls': <class 'configs.LlmConfig'>, 'confi...
     |
     ...
     |
     |  __pydantic_validator__ = SchemaValidator(title="LlmConfig", validator=...
     |
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\mem0-analysis\repo\mem0\llms\configs.py
