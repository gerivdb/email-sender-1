...
CLASSES
    ...
    class HashCommand(pip._internal.cli.base_command.Command)
     |  HashCommand(name: str, summary: str, isolated: bool = False) -> None
     |
...
DATA
    ...
    SUCCESS = 0
    logger = <VerboseLogger hash (WARNING)>

FILE
    d:\do\web\n8n_tests\projets\email_sender_1\projet\venv\lib\site-packages\pip\_internal\commands\hash.py
