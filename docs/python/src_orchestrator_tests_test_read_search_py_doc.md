Help on module test_read_search:

NAME
    test_read_search - Tests pour le module de lecture et recherche thématique.

CLASSES
    unittest.case.TestCase(builtins.object)
        TestThematicReadSearch

    class TestThematicReadSearch(unittest.case.TestCase)
     |  TestThematicReadSearch(methodName='runTest')
     |
     ...
     |      Skip this test.
     |
     |  subTest(self, msg=<object object at 0x00000247DF548860>, **params)
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\src\orchestrator\tests\test_read_search.py
