Help on module iqr_report_multimodal:

NAME
    iqr_report_multimodal
...
FUNCTIONS
    create_iqr_precision_report_multimodal(data: numpy.ndarray, bin_counts: List[int] = [10, 20, 50, 100, 200], kde_points: List[int] = [100, 200, 500, 1000, 2000], save_path: Optional[str] = None, show_plot: bool = True) -> Dict[str, Any]
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\projet\code\metrics\iqr_report_multimodal.py
