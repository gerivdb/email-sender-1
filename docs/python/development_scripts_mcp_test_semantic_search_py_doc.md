Help on module test_semantic_search:
...
CLASSES
    ...
    class TestSemanticSearch(unittest.case.TestCase)
     |  TestSemanticSearch(methodName='runTest')
     |
     ...
     |
     |  test_search_semantic(self)
     |      Teste la recherche sémantique.
     |
     |  test_search_with_reranking(self)
     ...
     |      Skip this test.
     |
     |  subTest(self, msg=<object object at 0x00000216C74F8860>, **params)
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\development\scripts\mcp\test_semantic_search.py
