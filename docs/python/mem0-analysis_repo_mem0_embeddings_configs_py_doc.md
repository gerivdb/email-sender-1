...
CLASSES
    ...
    class EmbedderConfig(pydantic.main.BaseModel)
     |  EmbedderConfig(*, provider: str = 'openai', config: Optional[dict] = {}) -> None
     |
     ...
     |
     |  __annotations__ = {'config': typing.Optional[dict], 'provider': <class...
     |
     |  __class_vars__ = set()
     |
     ...
     |
     |  __pydantic_core_schema__ = {'cls': <class 'configs.EmbedderConfig'>, '...
     |
     ...
     |
     |  __pydantic_validator__ = SchemaValidator(title="EmbedderConfig", valid...
     |
     |  __signature__ = <Signature (*, provider: str = 'openai', config: Optio...
     |
     |  model_config = {}
     |
     |  ----------------------------------------------------------------------
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\mem0-analysis\repo\mem0\embeddings\configs.py
