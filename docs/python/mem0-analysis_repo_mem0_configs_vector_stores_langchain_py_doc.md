...
CLASSES
    ...
    class LangchainConfig(pydantic.main.BaseModel)
     |  LangchainConfig(*, client: langchain_core.vectorstores.base.VectorStore, collection_name: str = 'mem0') -> None
     |
     ...
     |
     |  VectorStore = <class 'langchain_core.vectorstores.base.VectorStore'>
     |      Interface for vector store.
     |
     |
     |  __abstractmethods__ = frozenset()
     |
     |  __annotations__ = {'VectorStore': typing.ClassVar[type], 'client': <cl...
     |
     |  __class_vars__ = {'VectorStore'}
     |
     ...
     |
     |  __pydantic_core_schema__ = {'cls': <class 'langchain.LangchainConfig'>...
     |
     |  __pydantic_custom_init__ = False
     |
     |  __pydantic_decorators__ = DecoratorInfos(validators={}, field_validato...
     |
     |  __pydantic_fields__ = {'client': FieldInfo(annotation=VectorStore, req...
     |
     ...
     |
     |  __pydantic_validator__ = SchemaValidator(title="LangchainConfig", vali...
     |
     |  __signature__ = <Signature (*, client: langchain_core.vectorstor...tor...
     |
     ...
     |
     |  model_fields = {'client': FieldInfo(annotation=VectorStore, required=T...
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\mem0-analysis\repo\mem0\configs\vector_stores\langchain.py
