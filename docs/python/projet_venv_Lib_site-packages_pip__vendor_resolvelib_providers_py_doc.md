...
CLASSES
    ...
    class AbstractProvider(builtins.object)
    ...
    class AbstractResolver(builtins.object)
     |  AbstractResolver(provider, reporter)
     |
     ...
     |
     |  base_exception = <class 'Exception'>
     |      Common base class for all non-exit exceptions.

FILE
    d:\do\web\n8n_tests\projets\email_sender_1\projet\venv\lib\site-packages\pip\_vendor\resolvelib\providers.py
