...
CLASSES
    ...
    class RedisDBConfig(pydantic.main.BaseModel)
     |  RedisDBConfig(*, redis_url: str, collection_name: str = 'mem0', embedding_model_dims: int = 1536) -> None
     |
     ...
     |
     |  __pydantic_core_schema__ = {'cls': <class 'redis.RedisDBConfig'>, 'con...
     |
     ...
     |
     |  __pydantic_validator__ = SchemaValidator(title="RedisDBConfig", valida...
     |
     |  __signature__ = <Signature (*, redis_url: str, collection_name: ...mem...
     |
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\mem0-analysis\repo\mem0\configs\vector_stores\redis.py
