...
FUNCTIONS
    ...
    exec_ = exec(source, globals=None, locals=None, /, *, closure=None)
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\projet\venv\lib\site-packages\pip\_vendor\urllib3\packages\six.py
