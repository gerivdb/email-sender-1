Help on module email_analysis_chain:

NAME
    email_analysis_chain - Module contenant la chaîne LLM pour l'analyse des réponses aux emails.
...
CLASSES
    ...
    class EmailAnalysisResult(pydantic.main.BaseModel)
     |  EmailAnalysisResult(*, sentiment: str, intention: str, dates_proposees: List[str] = <factory>, questions: List[str] = <factory>, points_importants: List[str] = <factory>, action_recommandee: str) -> None
     |
     ...
     |
     |  __annotations__ = {'action_recommandee': <class 'str'>, 'dates_propose...
     |
     |  __class_vars__ = set()
     |
     ...
     |
     |  __pydantic_core_schema__ = {'cls': <class 'email_analysis_chain.EmailA...
     |
     |  __pydantic_custom_init__ = False
     |
     |  __pydantic_decorators__ = DecoratorInfos(validators={}, field_validato...
     |
     |  __pydantic_fields__ = {'action_recommandee': FieldInfo(annotation=str,...
     |
     ...
     |
     |  __pydantic_validator__ = SchemaValidator(title="EmailAnalysisResult", ...
     |
     |  __signature__ = <Signature (*, sentiment: str, intention: str, d...r] ...
     |
     |  model_config = {}
     |
     |  ----------------------------------------------------------------------
     ...
     |
     |  model_fields = {'action_recommandee': FieldInfo(annotation=str, requir...
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\src\langchain\chains\llm_chains\email_analysis_chain.py
