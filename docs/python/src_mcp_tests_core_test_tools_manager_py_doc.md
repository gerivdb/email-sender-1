Help on module test_tools_manager:
...
CLASSES
    ...
    class TestToolsManager(unittest.case.TestCase)
     |  TestToolsManager(methodName='runTest')
     |
     ...
     |      Skip this test.
     |
     |  subTest(self, msg=<object object at 0x0000021C5E458860>, **params)
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\src\mcp\tests\core\test_tools_manager.py
