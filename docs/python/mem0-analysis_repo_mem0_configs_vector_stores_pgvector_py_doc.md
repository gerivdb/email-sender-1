...
CLASSES
    ...
    class PGVectorConfig(pydantic.main.BaseModel)
     |  PGVectorConfig(*, dbname: str = 'postgres', collection_name: str = 'mem0', embedding_model_dims: Optional[int] = 1536, user: Optional[str] = None, password: Optional[str] = None, host: Optional[str] = None, port: Optional[int] = None, diskann: Optional[bool] = True, hnsw: Optional[bool] = False) -> None
     |
     ...
     |
     |  check_auth_and_connection(values)
     |
     ...
     |
     |  __annotations__ = {'collection_name': <class 'str'>, 'dbname': <class ...
     |
     |  __class_vars__ = set()
     |
     ...
     |
     |  __pydantic_core_schema__ = {'cls': <class 'pgvector.PGVectorConfig'>, ...
     |
     ...
     |
     |  __pydantic_validator__ = SchemaValidator(title="PGVectorConfig", valid...
     |
     |  __signature__ = <Signature (*, dbname: str = 'postgres', collect...l] ...
     |
     |  model_config = {}
     |
     |  ----------------------------------------------------------------------
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\mem0-analysis\repo\mem0\configs\vector_stores\pgvector.py
