...
CLASSES
    ...
    class TestClient(unittest.case.TestCase)
     |  TestClient(methodName='runTest')
     |
     ...
     |
     |  test_call_mcp_tool_error(self, mock_post)
     |      Teste l'appel à un outil avec une erreur.
     |
     |  test_call_mcp_tool_success(self, mock_post)
     ...
     |      Skip this test.
     |
     |  subTest(self, msg=<object object at 0x00000219EC8F8860>, **params)
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\src\mcp\core\tests\test_client.py
