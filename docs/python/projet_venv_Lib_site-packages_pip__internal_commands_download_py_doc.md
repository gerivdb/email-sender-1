...
CLASSES
    ...
    class DownloadCommand(pip._internal.cli.req_command.RequirementCommand)
     |  DownloadCommand(*args: Any, **kw: Any) -> None
     |
...
DATA
    ...
    SUCCESS = 0
    logger = <VerboseLogger download (WARNING)>

FILE
    d:\do\web\n8n_tests\projets\email_sender_1\projet\venv\lib\site-packages\pip\_internal\commands\download.py
