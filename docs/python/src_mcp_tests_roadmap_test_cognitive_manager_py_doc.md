Help on module test_cognitive_manager:
...
CLASSES
    unittest.case.TestCase(builtins.object)
        TestCognitiveManager

    class TestCognitiveManager(unittest.case.TestCase)
     |  TestCognitiveManager(methodName='runTest')
     |
     ...
     |      Skip this test.
     |
     |  subTest(self, msg=<object object at 0x00000170BE8D8860>, **params)
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\src\mcp\tests\roadmap\test_cognitive_manager.py
