Help on module test_theme_attribution:

NAME
    test_theme_attribution - Tests pour le module d'attribution thématique automatique.

CLASSES
    unittest.case.TestCase(builtins.object)
        TestThemeAttributor

    class TestThemeAttributor(unittest.case.TestCase)
     |  TestThemeAttributor(methodName='runTest')
     |
     ...
     |      Skip this test.
     |
     |  subTest(self, msg=<object object at 0x0000020CBE688860>, **params)
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\src\orchestrator\tests\test_theme_attribution.py
