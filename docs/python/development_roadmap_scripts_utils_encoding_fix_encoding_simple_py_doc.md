Help on module fix_encoding_simple:

NAME
    fix_encoding_simple - Script simple pour corriger les problèmes d'encodage dans un fichier Markdown.
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\development\roadmap\scripts\utils\encoding\fix_encoding_simple.py
