Help on module test_memory_tools:

NAME
    test_memory_tools - Tests unitaires pour les outils de mémoire MCP.
...
CLASSES
    ...
    class TestMemoryTools(unittest.case.TestCase)
     |  TestMemoryTools(methodName='runTest')
     |
     ...
     |
     |  test_add_memories_tool(self)
     |      Test de l'outil add_memories.
     |
     |  test_add_memories_tool_invalid_params(self)
     |      Test de l'outil add_memories avec des paramètres invalides.
     |
     |  test_delete_memories_tool_by_filters(self)
     |      Test de l'outil delete_memories par filtres.
     |
     |  test_delete_memories_tool_by_ids(self)
     |      Test de l'outil delete_memories par IDs.
     |
     |  test_delete_memories_tool_without_confirmation(self)
     |      Test de l'outil delete_memories sans confirmation.
     |
     |  test_list_memories_tool(self)
     |      Test de l'outil list_memories.
     |
     |  test_list_memories_tool_with_filters(self)
     |      Test de l'outil list_memories avec des filtres.
     |
     |  test_search_memory_tool(self)
     |      Test de l'outil search_memory.
     |
     |  test_search_memory_tool_with_filters(self)
     ...
     |      Skip this test.
     |
     |  subTest(self, msg=<object object at 0x0000020137238860>, **params)
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\src\mcp\tests\memory\test_memory_tools.py
