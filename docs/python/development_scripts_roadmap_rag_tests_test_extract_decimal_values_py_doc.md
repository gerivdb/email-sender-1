Help on module test_extract_decimal_values:
...
CLASSES
    unittest.case.TestCase(builtins.object)
        TestExtractDecimalValues

    class TestExtractDecimalValues(unittest.case.TestCase)
     |  TestExtractDecimalValues(methodName='runTest')
     |
     ...
     |
     |  test_extract_decimal_values_with_comma(self)
     |      Test avec des valeurs décimales avec virgule
     |
     |  test_extract_decimal_values_with_hours(self)
     |      Test avec des valeurs décimales avec des heures
     |
     |  test_extract_decimal_values_with_multiple_values(self)
     |      Test avec plusieurs valeurs décimales
     |
     |  test_extract_decimal_values_with_point(self)
     ...
     |      Skip this test.
     |
     |  subTest(self, msg=<object object at 0x0000015E28438860>, **params)
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\development\scripts\roadmap\rag\tests\test_extract_decimal_values.py
