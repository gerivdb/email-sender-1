...
CLASSES
    ...
    class FAISSConfig(pydantic.main.BaseModel)
     |  FAISSConfig(*, collection_name: str = 'mem0', path: Optional[str] = None, distance_strategy: str = 'euclidean', normalize_L2: bool = False, embedding_model_dims: int = 1536) -> None
     |
     ...
     |
     |  validate_distance_strategy(values: Dict[str, Any]) -> Dict[str, Any]
     |
     ...
     |
     |  __annotations__ = {'collection_name': <class 'str'>, 'distance_strateg...
     |
     |  __class_vars__ = set()
     |
     ...
     |
     |  __pydantic_core_schema__ = {'cls': <class 'faiss.FAISSConfig'>, 'confi...
     |
     ...
     |
     |  __pydantic_validator__ = SchemaValidator(title="FAISSConfig", validato...
     |
     |  __signature__ = <Signature (*, collection_name: str = 'mem0', pa...Fal...
     |
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\mem0-analysis\repo\mem0\configs\vector_stores\faiss.py
