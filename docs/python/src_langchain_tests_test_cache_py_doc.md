...
CLASSES
    ...
    class TestCacheManager(unittest.case.TestCase)
     |  TestCacheManager(methodName='runTest')
     |
     ...
     |      Skip this test.
     |
     |  subTest(self, msg=<object object at 0x0000027472818860>, **params)
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\src\langchain\tests\test_cache.py
