Help on module test_code_tools:
...
CLASSES
    ...
    class TestCodeTools(unittest.case.TestCase)
     |  TestCodeTools(methodName='runTest')
     |
     ...
     |
     |  test_analyze_code_tool(self)
     |      Teste l'outil analyze_code.
     |
     |  test_get_code_structure_tool(self)
     |      Teste l'outil get_code_structure.
     |
     |  test_search_code_tool(self)
     ...
     |      Skip this test.
     |
     |  subTest(self, msg=<object object at 0x0000026C2B4B8860>, **params)
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\src\mcp\tests\code\test_code_tools.py
