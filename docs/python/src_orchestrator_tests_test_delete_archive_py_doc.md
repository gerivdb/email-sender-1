Help on module test_delete_archive:

NAME
    test_delete_archive - Tests pour le module de suppression et archivage thématique.

CLASSES
    unittest.case.TestCase(builtins.object)
        TestThematicDeleteArchive

    class TestThematicDeleteArchive(unittest.case.TestCase)
     |  TestThematicDeleteArchive(methodName='runTest')
     |
     ...
     |      Skip this test.
     |
     |  subTest(self, msg=<object object at 0x000002BB4D758860>, **params)
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\src\orchestrator\tests\test_delete_archive.py
