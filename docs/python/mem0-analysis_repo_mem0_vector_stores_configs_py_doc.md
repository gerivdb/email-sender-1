...
CLASSES
    ...
    class VectorStoreConfig(pydantic.main.BaseModel)
     |  VectorStoreConfig(*, provider: str = 'qdrant', config: Optional[Dict] = None) -> None
     |
     ...
     |          context: The context.
     |
     |  validate_and_create_config(self) -> 'VectorStoreConfig'
     |
     |  ----------------------------------------------------------------------
     ...
     |
     |  __annotations__ = {'_provider_configs': typing.Dict[str, str], 'config...
     |
     |  __class_vars__ = set()
     |
     |  __private_attributes__ = {'_provider_configs': ModelPrivateAttr(defaul...
     |
     |  __pydantic_complete__ = True
     |
     |  __pydantic_computed_fields__ = {}
     |
     |  __pydantic_core_schema__ = {'function': {'function': <function VectorS...
     |
     |  __pydantic_custom_init__ = False
     |
     |  __pydantic_decorators__ = DecoratorInfos(validators={}, field_validato...
     |
     |  __pydantic_fields__ = {'config': FieldInfo(annotation=Union[Dict, None...
     |
     ...
     |
     |  __pydantic_validator__ = SchemaValidator(title="VectorStoreConfig", va...
     |
     |  __signature__ = <Signature (*, provider: str = 'qdrant', config: Optio...
     |
     |  model_config = {}
     |
     |  ----------------------------------------------------------------------
     ...
     |
     |  model_fields = {'config': FieldInfo(annotation=Union[Dict, NoneType], ...
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\mem0-analysis\repo\mem0\vector_stores\configs.py
