Help on module test_document_tools:
...
CLASSES
    ...
    class TestDocumentTools(unittest.case.TestCase)
     |  TestDocumentTools(methodName='runTest')
     |
     ...
     |
     |  test_fetch_documentation_tool(self)
     |      Test de l'outil fetch_documentation.
     |
     |  test_fetch_documentation_tool_invalid_params(self)
     |      Test de l'outil fetch_documentation avec des paramètres invalides.
     |
     |  test_read_file_tool(self)
     |      Test de l'outil read_file.
     |
     |  test_read_file_tool_invalid_params(self)
     |      Test de l'outil read_file avec des paramètres invalides.
     |
     |  test_read_file_tool_nonexistent_file(self)
     |      Test de l'outil read_file avec un fichier inexistant.
     |
     |  test_search_documentation_tool(self)
     |      Test de l'outil search_documentation.
     |
     |  test_search_documentation_tool_invalid_params(self)
     ...
     |      Skip this test.
     |
     |  subTest(self, msg=<object object at 0x000002625D548860>, **params)
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\src\mcp\tests\document\test_document_tools.py
