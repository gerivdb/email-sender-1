...
CLASSES
    ...
    class ChromaDbConfig(pydantic.main.BaseModel)
     |  ChromaDbConfig(*, collection_name: str = 'mem0', client: Optional[chromadb.api.client.Client] = None, path: Optional[str] = None, host: Optional[str] = None, port: Optional[int] = None) -> None
     |
     ...
     |
     |  __annotations__ = {'Client': typing.ClassVar[type], 'client': typing.O...
     |
     |  __class_vars__ = {'Client'}
     |
     ...
     |
     |  __pydantic_core_schema__ = {'cls': <class 'chroma.ChromaDbConfig'>, 'c...
     |
     |  __pydantic_custom_init__ = False
     |
     |  __pydantic_decorators__ = DecoratorInfos(validators={}, field_validato...
     |
     |  __pydantic_fields__ = {'client': FieldInfo(annotation=Union[Client, No...
     |
     ...
     |
     |  __pydantic_validator__ = SchemaValidator(title="ChromaDbConfig", valid...
     |
     |  __signature__ = <Signature (*, collection_name: str = 'mem0', cl...str...
     |
     ...
     |
     |  model_fields = {'client': FieldInfo(annotation=Union[Client, NoneType]...
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\mem0-analysis\repo\mem0\configs\vector_stores\chroma.py
