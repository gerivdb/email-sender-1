...
CLASSES
    unittest.case.TestCase(builtins.object)
        TestCodeAnalysisTools
        TestDocumentationTools
        TestRecommendationTools

    class TestCodeAnalysisTools(unittest.case.TestCase)
     |  TestCodeAnalysisTools(methodName='runTest')
     |
     ...
     |
     |  test_analyze_python_code(self)
     |      Teste l'analyse de code Python.
     |
     |  test_detect_code_smells(self)
     ...
     |      Skip this test.
     |
     |  subTest(self, msg=<object object at 0x00000172BA958860>, **params)
    ...
    class TestDocumentationTools(unittest.case.TestCase)
     |  TestDocumentationTools(methodName='runTest')
     |
     ...
     |      Initialisation des tests.
     |
     |  test_extract_docstrings(self)
     |      Teste l'extraction des docstrings.
     |
     |  test_generate_markdown_documentation(self)
    ...
    class TestRecommendationTools(unittest.case.TestCase)
     |  TestRecommendationTools(methodName='runTest')
     |
     ...
     |      Initialisation des tests.
     |
     |  test_recommend_code_improvements(self)
     |      Teste les recommandations d'amélioration de code.
     |
     |  test_recommend_technology_stack(self)
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\src\langchain\tests\test_tools.py
