Help on module azure_ai_search:
...
CLASSES
    ...
    class AzureAISearchConfig(pydantic.main.BaseModel)
     |  AzureAISearchConfig(*, collection_name: str = 'mem0', service_name: str = None, api_key: str = None, embedding_model_dims: int = 1536, compression_type: Optional[str] = None, use_float16: bool = False, hybrid_search: bool = False, vector_filter_mode: Optional[str] = 'preFilter') -> None
     |
     ...
     |
     |  __annotations__ = {'api_key': <class 'str'>, 'collection_name': <class...
     |
     |  __class_vars__ = set()
     |
     ...
     |
     |  __pydantic_core_schema__ = {'cls': <class 'azure_ai_search.AzureAISear...
     |
     |  __pydantic_custom_init__ = False
     |
     |  __pydantic_decorators__ = DecoratorInfos(validators={}, field_validato...
     |
     |  __pydantic_fields__ = {'api_key': FieldInfo(annotation=str, required=F...
     |
     ...
     |
     |  __pydantic_validator__ = SchemaValidator(title="AzureAISearchConfig", ...
     |
     |  __signature__ = <Signature (*, collection_name: str = 'mem0', se...ilt...
     |
     ...
     |
     |  model_fields = {'api_key': FieldInfo(annotation=str, required=False, d...
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\mem0-analysis\repo\mem0\configs\vector_stores\azure_ai_search.py
