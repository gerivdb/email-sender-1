Help on module run_tests:

NAME
    run_tests - Script pour exécuter tous les tests de l'orchestrateur.

DESCRIPTION
    Ce script découvre et exécute tous les tests dans le répertoire tests.

FUNCTIONS
    run_tests(pattern='test_*.py', test_name=None)
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\src\orchestrator\run_tests.py
