Help on module test_manager:

NAME
    test_manager - Tests pour le gestionnaire CRUD modulaire thématique.

CLASSES
    unittest.case.TestCase(builtins.object)
        TestThematicCRUDManager

    class TestThematicCRUDManager(unittest.case.TestCase)
     |  TestThematicCRUDManager(methodName='runTest')
     |
     ...
     |
     |  test_crud_operations(self)
     |      Teste les opérations CRUD de base.
     |
     |  test_search_operations(self)
     |      Teste les opérations de recherche.
     |
     |  test_theme_attribution(self)
     |      Teste l'attribution thématique.
     |
     |  test_theme_operations(self)
     ...
     |      Skip this test.
     |
     |  subTest(self, msg=<object object at 0x000001A7A52F8860>, **params)
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\src\orchestrator\tests\test_manager.py
