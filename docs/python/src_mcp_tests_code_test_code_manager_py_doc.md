Help on module test_code_manager:
...
CLASSES
    ...
    class TestCodeManager(unittest.case.TestCase)
     |  TestCodeManager(methodName='runTest')
     |
     ...
     |
     |  test_analyze_code(self)
     |      Teste la méthode analyze_code.
     |
     |  test_get_code_structure(self)
     |      Teste la méthode get_code_structure.
     |
     |  test_search_code(self)
     ...
     |      Skip this test.
     |
     |  subTest(self, msg=<object object at 0x000001D120768860>, **params)
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\src\mcp\tests\code\test_code_manager.py
