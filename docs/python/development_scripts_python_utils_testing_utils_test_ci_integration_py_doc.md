Help on module test_ci_integration:

NAME
    test_ci_integration - Tests unitaires pour l'intégration CI/CD

CLASSES
    unittest.case.TestCase(builtins.object)
        TestCIIntegration

    class TestCIIntegration(unittest.case.TestCase)
     |  TestCIIntegration(methodName='runTest')
     |
     ...
     |      Skip this test.
     |
     |  subTest(self, msg=<object object at 0x0000027167D78860>, **params)
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\development\scripts\python\utils\testing_utils\test_ci_integration.py
