Help on module test_memory_schema:

NAME
    test_memory_schema - Script de test pour le schéma de métadonnées des mémoires.

CLASSES
    unittest.case.TestCase(builtins.object)
        TestMemorySchema

    class TestMemorySchema(unittest.case.TestCase)
     |  TestMemorySchema(methodName='runTest')
     |
     ...
     |      Skip this test.
     |
     |  subTest(self, msg=<object object at 0x00000153BDF288B0>, **params)
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\development\scripts\mcp\test_memory_schema.py
