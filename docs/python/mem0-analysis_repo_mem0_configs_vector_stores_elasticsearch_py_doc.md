...
CLASSES
    ...
    class ElasticsearchConfig(pydantic.main.BaseModel)
     |  ElasticsearchConfig(*, collection_name: str = 'mem0', host: str = 'localhost', port: int = 9200, user: Optional[str] = None, password: Optional[str] = None, cloud_id: Optional[str] = None, api_key: Optional[str] = None, embedding_model_dims: int = 1536, verify_certs: bool = True, use_ssl: bool = True, auto_create_index: bool = True, custom_search_query: Optional[collections.abc.Callable[[List[float], int, Optional[Dict]], Dict]] = None) -> None
     |
     ...
     |
     |  __pydantic_core_schema__ = {'cls': <class 'elasticsearch.Elasticsearch...
     |
     ...
     |
     |  __pydantic_validator__ = SchemaValidator(title="ElasticsearchConfig", ...
     |
     |  __signature__ = <Signature (*, collection_name: str = 'mem0', ho...t],...
     |
     |  model_config = {}
     |
     |  ----------------------------------------------------------------------
...
FILE
    d:\do\web\n8n_tests\projets\email_sender_1\mem0-analysis\repo\mem0\configs\vector_stores\elasticsearch.py
