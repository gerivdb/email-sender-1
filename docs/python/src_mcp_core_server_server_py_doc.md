...
NAME
    server - Serveur FastAPI qui expose des outils similaires à MCP.
...
CLASSES
    ...
    class AddRequest(pydantic.main.BaseModel)
     |  AddRequest(*, a: int, b: int) -> None
     |
     |  # Modèles de données
     |
     ...
     |
     |  __pydantic_core_schema__ = {'cls': <class 'server.AddRequest'>, 'confi...
     |
     |  __pydantic_custom_init__ = False
     |
     |  __pydantic_decorators__ = DecoratorInfos(validators={}, field_validato...
     |
     |  __pydantic_fields__ = {'a': FieldInfo(annotation=int, required=True), ...
     |
     ...
     |
     |  __pydantic_validator__ = SchemaValidator(title="AddRequest", validator...
     |
     |  __signature__ = <Signature (*, a: int, b: int) -> None>
     |
     |  model_config = {}
     |
     |  ----------------------------------------------------------------------
     ...
     |
     |  model_fields = {'a': FieldInfo(annotation=int, required=True), 'b': Fi...

    class MultiplyRequest(pydantic.main.BaseModel)
     |  MultiplyRequest(*, a: int, b: int) -> None
     |
     |  Method resolution order:
     |      MultiplyRequest
     |      pydantic.main.BaseModel
     ...
     |  __pydantic_computed_fields__ = {}
     |
     |  __pydantic_core_schema__ = {'cls': <class 'server.MultiplyRequest'>, '...
     |
     |  __pydantic_custom_init__ = False
     |
     |  __pydantic_decorators__ = DecoratorInfos(validators={}, field_validato...
     ...
     |  __pydantic_setattr_handlers__ = {}
     |
     |  __pydantic_validator__ = SchemaValidator(title="MultiplyRequest", vali...
     |
     |  __signature__ = <Signature (*, a: int, b: int) -> None>
     |
     |  model_config = {}
    ...
    class SystemInfoResponse(pydantic.main.BaseModel)
     |  SystemInfoResponse(*, os: str, os_version: str, python_version: str, hostname: str, cpu_count: int) -> None
     |
     |  Method resolution order:
     |      SystemInfoResponse
     |      pydantic.main.BaseModel
     ...
     |  __abstractmethods__ = frozenset()
     |
     |  __annotations__ = {'cpu_count': <class 'int'>, 'hostname': <class 'str...
     |
     |  __class_vars__ = set()
     |
     |  __private_attributes__ = {}
     ...
     |  __pydantic_computed_fields__ = {}
     |
     |  __pydantic_core_schema__ = {'cls': <class 'server.SystemInfoResponse'>...
     |
     |  __pydantic_custom_init__ = False
     |
     |  __pydantic_decorators__ = DecoratorInfos(validators={}, field_validato...
     |
     |  __pydantic_fields__ = {'cpu_count': FieldInfo(annotation=int, required...
     |
     |  __pydantic_generic_metadata__ = {'args': (), 'origin': None, 'paramete...
     |
     |  __pydantic_parent_namespace__ = None
     ...
     |  __pydantic_setattr_handlers__ = {}
     |
     |  __pydantic_validator__ = SchemaValidator(title="SystemInfoResponse", v...
     |
     |  __signature__ = <Signature (*, os: str, os_version: str, python_...ion...
     |
     |  model_config = {}
     |
     |  ----------------------------------------------------------------------
     ...
     |  model_computed_fields = {}
     |
     |  model_fields = {'cpu_count': FieldInfo(annotation=int, required=True),...

FUNCTIONS
    async add_tool(request: server.AddRequest)

    async get_system_info_tool()

    async list_tools()

    async multiply_tool(request: server.MultiplyRequest)
...
DATA
    ...
    logger = <Logger mcp_server (DEBUG)>

FILE
    d:\do\web\n8n_tests\projets\email_sender_1\src\mcp\core\server\server.py
