...
Paramètres:
    ...
    * **ConfigPath** (*String*) - Chemin du fichier de configuration. Valeur par défaut : ".\config\dependency_manager.json"
...
.. code-block:: powershell
    ...
    Initialize-DependencyManager -Enabled $true -CacheEnabled $true -MaxDepth 50 -ConfigPath ".\config\custom_dependency_config.json"
...
.. code-block:: powershell
    ...
    $result = Install-Dependencies -Path ".\scripts\main.ps1" -Scope "CurrentUser"
