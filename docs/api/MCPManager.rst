...
Paramètres:
    ...
    * **ConfigPath** (*String*) - Chemin du fichier de configuration. Valeur par défaut : ".\config\mcp_manager.json"
...
Paramètres:
    * **OutputPath** (*String*) - Chemin du fichier de configuration à créer. Par défaut : ".\config\mcp_config.json"
...
Paramètres:
    ...
    * **Port** (*Int32*) - Numéro de port du serveur MCP. Par défaut : 8000
    * **Host** (*String*) - Nom ou adresse IP de l'hôte. Par défaut : "localhost"
    * **ConfigPath** (*String*) - Chemin du fichier de configuration. Par défaut : ".\config\mcp_config.json"
