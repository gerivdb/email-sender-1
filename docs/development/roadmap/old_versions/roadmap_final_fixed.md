...
- `scripts/mcp/configure-vscode-mcp.ps1` (modifiÃ©)
- `scripts/mcp/start-all-mcp-complete-v2.ps1` (modifiÃ©)
- `scripts/mcp/check-mcp-servers-v2-noadmin.ps1` (modifiÃ©)
- `scripts/mcp/tests/CheckMcpServers.Tests.ps1` (modifiÃ©)
- `scripts/mcp/tests/StartAllMcpComplete.Tests.ps1` (modifiÃ©)
- `scripts/mcp/tests/TestOmnibus.ps1` (modifiÃ©)
- `docs/guides/RESOLUTION_PROBLEMES_MCP.md` (modifiÃ©)
...
- [x] Mettre Ã  jour la documentation
  - [x] Mettre Ã  jour `docs/guides/RESOLUTION_PROBLEMES_MCP.md` avec les nouvelles instructions
...
- `scripts/roadmap/Add-RoadmapJournalEntry.ps1`
- `scripts/roadmap/Update-RoadmapJournalStatus.ps1`
- `scripts/roadmap/Show-RoadmapJournalDashboard.ps1`
- `scripts/roadmap/Export-RoadmapJournalToMarkdown.ps1`
- `scripts/roadmap/Sync-RoadmapWithJournal.ps1`
- `scripts/roadmap/Import-ExistingRoadmapToJournal.ps1`
- `scripts/roadmap/Analyze-RoadmapJournal.ps1`
- `scripts/roadmap/Generate-RoadmapJournalReport.ps1`
