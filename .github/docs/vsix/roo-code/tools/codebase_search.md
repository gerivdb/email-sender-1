...
Setup RequiredThe codebase_search tool is part of the Codebase Indexing feature. It requires additional setup including an embedding provider and vector database.
