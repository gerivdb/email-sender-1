<#
.SYNOPSIS
    Adaptateur TestOmnibus pour les tests de dÃƒÂ©tection des erreurs d'encodage.
.DESCRIPTION
    Cet adaptateur permet d'exÃƒÂ©cuter les tests de dÃƒÂ©tection des erreurs d'encodage
...
function Invoke-EncodingErrorDetectionTests {
    ...
    Write-Host "ExÃƒÂ©cution des tests de dÃƒÂ©tection des erreurs d'encodage..." -ForegroundColor Cyan
...
<head>
    <meta charset="UTF-8">
    <title>Rapport de tests - DÃƒÂ©tection des erreurs d'encodage</title>
    <style>
...
<body>
    <h1>Rapport de tests - DÃƒÂ©tection des erreurs d'encodage</h1>
