<#
.SYNOPSIS
    Ex̩cute tous les tests unitaires pour le syst̬me de cache pr̩dictif.
.DESCRIPTION
    Ce script ex̩cute tous les tests unitaires pour le syst̬me de cache pr̩dictif
