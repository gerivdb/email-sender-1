<#
.SYNOPSIS
    Tests progressifs pour les fonctionnalités de clonage profond (DeepClone).
...
BeforeAll {
    ...
    $scriptPath = Join-Path -Path $PSScriptRoot -ChildPath "..\..\DeepCloneExtensions.Simple.ps1"
...
Describe "Invoke-DeepClone - Tests d'exceptions" -Tag "P3" {
    Context "Gestion des erreurs" {
        ...
        It "Gère correctement les références circulaires" {
            ...
            # Act & Assert
            { Invoke-DeepClone -InputObject $obj1 } | Should -Throw
        }
    }
}
...
Describe "Invoke-PSObjectDeepClone - Tests d'exceptions" -Tag "P3" {
    Context "Gestion des erreurs" {
        It "Gère correctement les propriétés non sérialisables" {
            ...
            # Act & Assert
            { Invoke-PSObjectDeepClone -InputObject $obj } | Should -Throw
        }
    }
}
#endregion
