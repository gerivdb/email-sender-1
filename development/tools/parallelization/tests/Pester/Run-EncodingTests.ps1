# Script pour exécuter les tests d'encodage
#Requires -Version 5.1
#Requires -Modules @{ ModuleName='Pester'; ModuleVersion='5.0.0' }

# Configurer Pester
$pesterConfig = [PesterConfiguration]::Default
$pesterConfig.Run.Path = Join-Path -Path $PSScriptRoot -ChildPath "Initialize-EncodingSettings.Tests.ps1"
$pesterConfig.Output.Verbosity = "Detailed"
$pesterConfig.Run.PassThru = $true
$pesterConfig.CodeCoverage.Enabled = $true
$pesterConfig.CodeCoverage.Path = Join-Path -Path $PSScriptRoot -ChildPath "..\..\UnifiedParallel.psm1"
$pesterConfig.CodeCoverage.OutputFormat = "JaCoCo"
$pesterConfig.CodeCoverage.OutputPath = Join-Path -Path $PSScriptRoot -ChildPath "..\..\coverage\EncodingTests.xml"
$pesterConfig.TestResult.Enabled = $true
$pesterConfig.TestResult.OutputFormat = "NUnitXml"
$pesterConfig.TestResult.OutputPath = Join-Path -Path $PSScriptRoot -ChildPath "..\..\coverage\EncodingTests.TestResults.xml"
...
# Exécuter les tests
Write-Host "Exécution des tests unitaires pour la fonction Initialize-EncodingSettings..." -ForegroundColor Cyan
