...
.EXAMPLE
    .\Run-DeepCloneTests.ps1 -Phase P1
...
$testScriptPath = Join-Path -Path $PSScriptRoot -ChildPath "DeepClonePS51.Progressive.Tests.ps1"
...
function Invoke-PhaseTests {
    ...
    Write-Host "Exécution des tests de phase $Phase..." -ForegroundColor Cyan
...
if ($Phase -eq 'All') {
    Write-Host "Exécution de tous les tests progressifs pour les fonctionnalités de clonage profond..." -ForegroundColor Green
