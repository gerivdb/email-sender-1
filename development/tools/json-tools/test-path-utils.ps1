...
function Start-PathTests {
    ...
    $path = "development/scripts/utilites/path-utils.ps1"
    ...
    $path = "development/scripts/utilites test/path-utils.ps1"
    # Utiliser directement la fonction du module Path-Manager
    ...
    $pathWithAccents = "development/scripts/utilites/path-utils.ps1"
