...
Chaque mode est impl̩ment̩ sous forme de script PowerShell dans le dossier `development/tools/development/roadmap/scripts/modes`. Par exemple, le mode CHECK est impl̩ment̩ dans le script `check-mode.ps1`.
