# Script pour corriger les noms des workflows en remplacant les caracteres accentues

# Creer un repertoire pour les fichiers corriges
...
# Traiter tous les fichiers JSON dans le repertoire de reference
...
foreach ($file in $workflowFiles) {
    ...
    try {
        ...
        # Remplacer les caracteres accentues dans le nom du workflow
        $originalName = $workflowJson.name
        $newName = $originalName
        
        # Remplacer manuellement les caracteres accentues
