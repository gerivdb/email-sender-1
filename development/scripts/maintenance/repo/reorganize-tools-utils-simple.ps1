...
$utilsReadmeContent += "- **analysis/** -> `development/tools/analysis/``n"
$utilsReadmeContent += "- **automation/** -> `development/tools/utilities/``n"
$utilsReadmeContent += "- **cache/** -> `development/tools/cache/``n"
$utilsReadmeContent += "- **CompatibleCode/** -> `development/tools/utilities/``n"
$utilsReadmeContent += "- **Converters/** -> `development/tools/converters/``n"
$utilsReadmeContent += "- **Detectors/** -> `development/tools/detectors/``n"
$utilsReadmeContent += "- **Docs/** -> `development/tools/documentation/``n"
$utilsReadmeContent += "- **ErrorHandling/** -> `development/tools/error-handling/``n"
$utilsReadmeContent += "- **Examples/** -> `development/tools/examples/``n"
$utilsReadmeContent += "- **git/** -> `development/tools/git/``n"
$utilsReadmeContent += "- **Integrations/** -> `development/tools/integrations/``n"
$utilsReadmeContent += "- **json/** -> `development/tools/json/``n"
$utilsReadmeContent += "- **markdown/** -> `development/tools/markdown/``n"
$utilsReadmeContent += "- **ProactiveOptimization/** -> `development/tools/optimization/``n"
$utilsReadmeContent += "- **PSCacheManager/** -> `development/tools/cache/``n"
$utilsReadmeContent += "- **roadmap/** -> `development/tools/roadmap/``n"
$utilsReadmeContent += "- **samples/** -> `development/tools/examples/``n"
$utilsReadmeContent += "- **TestOmnibus/** -> `development/tools/testing/``n"
$utilsReadmeContent += "- **TestOmnibusOptimizer/** -> `development/tools/testing/``n"
$utilsReadmeContent += "- **Tests/** -> `development/tools/testing/``n"
$utilsReadmeContent += "- **UsageMonitor/** -> `development/tools/utilities/``n"
$utilsReadmeContent += "- **utils/** -> `development/tools/utilities/``n"
