...
$replacements = @{
    ...
    "& .*?roadmap-manager\.ps1" = "& `"development\scripts\integrated-manager.ps1`" -Interactive"
    "& .*?\\roadmap-manager\.ps1" = "& `"development\scripts\integrated-manager.ps1`" -Interactive"
    "& .*?/roadmap-manager\.ps1" = "& `"development\scripts\integrated-manager.ps1`" -Interactive"
    "Invoke-Expression .*?roadmap-manager\.ps1" = "Invoke-Expression `"& 'development\scripts\integrated-manager.ps1' -Interactive`""
    "Invoke-Expression .*?\\roadmap-manager\.ps1" = "Invoke-Expression `"& 'development\scripts\integrated-manager.ps1' -Interactive`""
    "Invoke-Expression .*?/roadmap-manager\.ps1" = "Invoke-Expression `"& 'development\scripts\integrated-manager.ps1' -Interactive`""
