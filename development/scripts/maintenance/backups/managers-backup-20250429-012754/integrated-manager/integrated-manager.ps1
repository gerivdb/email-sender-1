...
$roadmapManagerPath = Join-Path -Path $projectRoot -ChildPath "projet\roadmaps\scripts\roadmap-manager.ps1"
    ...
    return [PSCustomObject]@{
        ...
        roadmapManager = [PSCustomObject]@{
            ...
            Scripts            = [PSCustomObject]@{
                Manager    = "projet\roadmaps\scripts\roadmap-manager.ps1"
