...
.EXAMPLE
    .\update-roadmap-structure-references.ps1
...
# Fonction principale
function Update-RoadmapStructureReferences {
    ...
    begin {
        ...
        $pathMappings = @(
            @{
                OldPath = "projet/roadmaps/mes-plans"
                NewPath = "projet/roadmaps/mes-plans"
                Description = "D̩placement des plans personnels"
            }
        )
    }
...
Update-RoadmapStructureReferences
