<#
.SYNOPSIS
    Met à jour les références après la réorganisation de la structure de la roadmap.
...
function Update-RoadmapReferences {
    ...
    begin {
        Write-Host "Mise à jour des références après la réorganisation de la structure de la roadmap..." -ForegroundColor Cyan
        ...
        $pathMappings = @(
            @{
                ...
                Description = "Déplacement des scripts de roadmap"
            },
            @{
                OldPath = "development/roadmap/scripts-parser"
                NewPath = "development/roadmap/parser"
                Description = "Déplacement du parser de roadmap"
            }
        )
    }
