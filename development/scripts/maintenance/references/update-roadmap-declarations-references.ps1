<#
.SYNOPSIS
    Met Ã  jour les rÃ©fÃ©rences aprÃ¨s le renommage du dossier Roadmap en declarations.

.DESCRIPTION
    Ce script met Ã  jour les rÃ©fÃ©rences dans les fichiers du projet aprÃ¨s le renommage
    du dossier development/roadmap/declarations en development/roadmap/declarations.

.EXAMPLE
    .\update-roadmap-declarations-references.ps1
...
# Fonction principale
function Update-RoadmapDeclarationsReferences {
    [CmdletBinding(SupportsShouldProcess=$true)]
    param()
    
    begin {
        Write-Host "Mise Ã  jour des rÃ©fÃ©rences aprÃ¨s le renommage du dossier Roadmap en declarations..." -ForegroundColor Cyan
        $ErrorActionPreference = "Stop"
        
        # DÃ©finir les mappages de chemins
        $pathMappings = @(
            @{
                OldPath = "development/roadmap/declarations"
                NewPath = "development/roadmap/declarations"
                Description = "Renommage du dossier Roadmap en declarations"
            }
        )
    }
...
Update-RoadmapDeclarationsReferences
