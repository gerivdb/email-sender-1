<#
.SYNOPSIS
    Met à jour les références après le renommage du dossier Roadmap en declarations.
...
function Update-RoadmapDeclarationsReferences {
    ...
    begin {
        Write-Host "Mise à jour des références après le renommage du dossier Roadmap en declarations..." -ForegroundColor Cyan
