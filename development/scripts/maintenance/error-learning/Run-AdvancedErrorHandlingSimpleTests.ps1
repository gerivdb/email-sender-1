<#
.SYNOPSIS
    Script pour ex̩cuter les tests de gestion des erreurs avanc̩e simplifi̩s du syst̬me d'apprentissage des erreurs.
.DESCRIPTION
    Ce script ex̩cute les tests de gestion des erreurs avanc̩e simplifi̩s du syst̬me d'apprentissage des erreurs.
.EXAMPLE
    .\Run-AdvancedErrorHandlingSimpleTests.ps1
    Ex̩cute les tests de gestion des erreurs avanc̩e simplifi̩s.
#>
...
# D̩finir le chemin du test de gestion des erreurs avanc̩e simplifi̩
$testFile = Join-Path -Path $PSScriptRoot -ChildPath "Tests\AdvancedErrorHandling.Simple.ps1"

# Afficher les tests trouv̩s
Write-Host "Test de gestion des erreurs avanc̩e simplifi̩ trouv̩ :" -ForegroundColor Cyan
Write-Host "  AdvancedErrorHandling.Simple.ps1" -ForegroundColor Yellow

# Ex̩cuter les tests
Write-Host "`nEx̩cution des tests de gestion des erreurs avanc̩e simplifi̩s..." -ForegroundColor Cyan
