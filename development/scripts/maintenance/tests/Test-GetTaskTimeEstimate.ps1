...
.DESCRIPTION
    ...
    qui permet d'estimer le temps nécessaire pour une sous-tâche.
...
if (-not $functionMatch.Success) {
    throw "La fonction Get-TaskTimeEstimate n'a pas été trouvée dans le fichier gran-mode.ps1"
}
...
"@ | Set-Content -Path $testConfigPath -Encoding UTF8
    ...
    It "Devrait détecter correctement le type de tâche d'analyse" {
        # Appeler la fonction avec une tâche d'analyse
        $result = Get-TaskTimeEstimate -TaskContent "Analyser les besoins du système" -ComplexityLevel "Medium" -ProjectRoot "C:\Temp"
    ...
    It "Devrait détecter correctement le type de tâche de conception" {
        # Appeler la fonction avec une tâche de conception
        $result = Get-TaskTimeEstimate -TaskContent "Concevoir l'architecture du système" -ComplexityLevel "Medium" -ProjectRoot "C:\Temp"
    ...
    It "Devrait détecter correctement le type de tâche d'implémentation" {
        # Appeler la fonction avec une tâche d'implémentation
        $result = Get-TaskTimeEstimate -TaskContent "Implémenter le module de connexion" -ComplexityLevel "Medium" -ProjectRoot "C:\Temp"
    ...
    It "Devrait détecter correctement le type de tâche de test" {
        # Appeler la fonction avec une tâche de test
    ...
    It "Devrait détecter correctement le type de tâche de documentation" {
        # Appeler la fonction avec une tâche de documentation
        $result = Get-TaskTimeEstimate -TaskContent "Documenter l'API du système" -ComplexityLevel "Medium" -ProjectRoot "C:\Temp"
    ...
    It "Devrait utiliser le type par défaut si aucun type n'est détecté" {
        # Appeler la fonction avec une tâche sans type spécifique
    ...
    It "Devrait appliquer le multiplicateur de complexité simple" {
        # Appeler la fonction avec une complexité simple
        $result = Get-TaskTimeEstimate -TaskContent "Implémenter le module de connexion" -ComplexityLevel "Simple" -ProjectRoot "C:\Temp"
    ...
    It "Devrait appliquer le multiplicateur de complexité complexe" {
        # Appeler la fonction avec une complexité complexe
        $result = Get-TaskTimeEstimate -TaskContent "Implémenter le module de connexion" -ComplexityLevel "Complex" -ProjectRoot "C:\Temp"
    ...
    It "Devrait appliquer le multiplicateur de domaine backend" {
        ...
        $result = Get-TaskTimeEstimate -TaskContent "Implémenter le module de connexion" -ComplexityLevel "Medium" -Domain "backend" -ProjectRoot "C:\Temp"

        # Vérifier le résultat
        $result.Type | Should -Be "implementation"
        $result.Time | Should -Be 4.8  # 4.0 * 1.2
        $result.Unit | Should -Be "h"
        $result.Formatted | Should -Be "4.5 h"  # Arrondi à 0.5 près
    }

    It "Devrait appliquer le multiplicateur de domaine documentation" {
        # Appeler la fonction avec un domaine documentation
        $result = Get-TaskTimeEstimate -TaskContent "Implémenter le module de connexion" -ComplexityLevel "Medium" -Domain "documentation" -ProjectRoot "C:\Temp"

        # Vérifier le résultat
        $result.Type | Should -Be "implementation"
        $result.Time | Should -Be 3.0  # 4.0 * 0.8 = 3.2, arrondi à 0.5 près = 3.0
        $result.Unit | Should -Be "h"
        $result.Formatted | Should -Be "3 h"
    }
    ...
    It "Devrait ignorer le domaine s'il n'est pas reconnu" {
        ...
        $result = Get-TaskTimeEstimate -TaskContent "Implémenter le module de connexion" -ComplexityLevel "Medium" -Domain "inconnu" -ProjectRoot "C:\Temp"
    ...
    It "Devrait combiner les multiplicateurs de complexité et de domaine" {
        # Appeler la fonction avec une complexité complexe et un domaine backend
        $result = Get-TaskTimeEstimate -TaskContent "Implémenter le module de connexion" -ComplexityLevel "Complex" -Domain "backend" -ProjectRoot "C:\Temp"

        # Vérifier le résultat
        $result.Type | Should -Be "implementation"
        $result.Time | Should -Be 9.5  # 4.0 * 2.0 * 1.2 = 9.6, arrondi à 0.5 près = 9.5
        $result.Unit | Should -Be "h"
