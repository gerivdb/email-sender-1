# Fonction pour gÃ©nÃ©rer des sous-tÃ¢ches avec l'IA via OpenRouter
...
# Demander Ã  l'utilisateur de saisir la clÃ© API OpenRouter
$apiKey = Read-Host -Prompt "Entrez votre clÃ© API OpenRouter"
