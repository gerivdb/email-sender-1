<#
.SYNOPSIS
    Tests unitaires pour v̩rifier le rapport des scores de complexit̩ technique.

.DESCRIPTION
    Ce script ex̩cute des tests unitaires pour v̩rifier que le rapport des scores
    de complexit̩ technique a ̩t̩ correctement cr̩̩ et contient toutes les informations n̩cessaires.

.PARAMETER DocumentPath
    Chemin vers le rapport des scores de complexit̩ technique.

.EXAMPLE
    .\Test-ComplexityScores.ps1 -DocumentPath "..\..\data\planning\complexity-scores.md"
    Ex̩cute les tests unitaires pour le rapport des scores de complexit̩ technique.
...
$tests = @(
    ...
    @{
        ...
        Test = {
            return ($documentContent -match "# Attribution des Scores de Complexit̩ Technique des Am̩liorations")
        }
    },
    @{
    ...
    @{
        Name = "Test de la pr̩sence des niveaux de complexit̩ technique"
        Test = {
            return ($documentContent -match "### Niveaux de Complexit̩ Technique")
        }
    },
    @{
        Name = "Test de la pr̩sence du tableau des niveaux de complexit̩"
        Test = {
            return ($documentContent -match "\| Niveau \| Score \| Description \|")
        }
    },
    @{
        Name = "Test de la pr̩sence du score de complexit̩ technique"
        Test = {
            return ($documentContent -match "#### Score de Complexit̩ Technique")
        }
    },
    @{
        Name = "Test de la pr̩sence des facteurs de complexit̩"
        Test = {
            return ($documentContent -match "\*\*Facteurs de complexit̩ :\*\*")
        }
    },
    @{
    ...
    @{
        Name = "Test de la pr̩sence de la justification pour la difficult̩ d'impl̩mentation"
        Test = {
            return ($documentContent -match "\*\*Difficult̩ d'impl̩mentation \(Score : \d+\) :\*\*")
        }
    },
    @{
        Name = "Test de la pr̩sence de la justification pour les risques techniques"
        Test = {
    ...
    @{
        Name = "Test de la pr̩sence de la r̩partition par niveau de complexit̩ technique"
        Test = {
            return ($documentContent -match "### R̩partition par Niveau de Complexit̩ Technique")
        }
    },
    @{
