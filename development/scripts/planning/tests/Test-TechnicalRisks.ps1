<#
.SYNOPSIS
    Tests unitaires pour vÃ©rifier le rapport des risques techniques.

.DESCRIPTION
    Ce script exÃ©cute des tests unitaires pour vÃ©rifier que le rapport des risques
    techniques a Ã©tÃ© correctement crÃ©Ã© et contient toutes les informations nÃ©cessaires.
...
.EXAMPLE
    ...
    ExÃ©cute les tests unitaires pour le rapport des risques techniques.
...
$tests = @(
    ...
    @{
        ...
        Test = {
            return ($documentContent -match "# Identification des Risques Techniques des AmÃ©liorations")
        }
    },
    @{
    ...
    @{
        Name = "Test de la prÃ©sence de l'Ã©valuation de la criticitÃ© des risques"
        Test = {
            return ($documentContent -match "### Ã‰valuation de la CriticitÃ© des Risques")
        }
    },
    @{
        Name = "Test de la prÃ©sence du tableau de criticitÃ©"
        Test = {
            return ($documentContent -match "\| Impact \| ProbabilitÃ© \| CriticitÃ© \|")
        }
    },
    @{
        Name = "Test de la prÃ©sence des risques identifiÃ©s"
        Test = {
            return ($documentContent -match "#### Risques IdentifiÃ©s")
        }
    },
    @{
        Name = "Test de la prÃ©sence du tableau des risques"
        Test = {
            return ($documentContent -match "\| CatÃ©gorie \| Description \| Impact \| ProbabilitÃ© \| CriticitÃ© \| Mitigation \|")
        }
    },
    @{
    ...
    @{
        Name = "Test de la prÃ©sence de la rÃ©partition par niveau de criticitÃ©"
        Test = {
            return ($documentContent -match "### RÃ©partition par Niveau de CriticitÃ©")
        }
    },
    @{
    ...
    @{
        Name = "Test de la prÃ©sence des recommandations gÃ©nÃ©rales"
        Test = {
            return ($documentContent -match "### Recommandations GÃ©nÃ©rales")
        }
    },
    @{
