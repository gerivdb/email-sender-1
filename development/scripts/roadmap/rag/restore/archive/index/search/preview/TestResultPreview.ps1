# TestResultPreview.ps1
# Script de test pour le module de previsualisation des resultats
# Version: 1.0
# Date: 2025-05-15
...
$documents = @(
    [PSCustomObject]@{
        ...
        content    = "Ce rapport presente les resultats financiers de l'annee 2024. Les revenus ont augmente de 15% par rapport a l'annee precedente. Les depenses ont diminue de 5%. Le benefice net a augmente de 25%."
