...
$filtersPath = Join-Path -Path $scriptPath -ChildPath "FinalSearchFilters.ps1"

if (Test-Path -Path $filtersPath) {
    . $filtersPath
} else {
    Write-Error "Le fichier FinalSearchFilters.ps1 est introuvable."
    exit 1
}
