# Simple-PrecisionVariables-Test.ps1
# Script de test simplifié pour l'extraction des nombres avec précisions variables
# Version: 1.0
# Date: 2025-05-15
...
Write-Host "- Tâches sans valeurs numériques à précisions variables: $(6 - $precisionVariables.Count)" -ForegroundColor Yellow
