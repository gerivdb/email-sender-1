# Test-DureeTags.ps1
# Script pour tester l'extraction des tags de type #durée
# Version: 1.0
# Date: 2025-05-15
...
## Tags de durée avec format parenthèses
- [ ] **4.1** Tâche avec tag de durée en jours #durée(5j)
- [ ] **4.2** Tâche avec tag de durée en semaines #durée(2s)
- [ ] **4.3** Tâche avec tag de durée en mois #durée(1m)
...
Write-Host "- Tâches sans tags de durée: $(17 - $dureeTags.Count)" -ForegroundColor Yellow
