...
$managerPaths = @{
    "roadmap-manager" = @{
        "OldPath" = Join-Path -Path $ProjectRoot -ChildPath "development\\managers\\roadmap-manager\\scripts\\roadmap-manager\.ps1"
        "NewPath" = Join-Path -Path $ProjectRoot -ChildPath "development\\managers\\roadmap-manager\\scripts\\roadmap-manager\.ps1"
        "NewDir" = Join-Path -Path $ProjectRoot -ChildPath "projet\roadmaps\scripts\roadmap-manager"
    }
    "MCPManager" = @{
        "OldPath" = Join-Path -Path $ProjectRoot -ChildPath "development\\managers\\mcp-manager\\scripts\\mcp-manager\.ps1"
        "NewPath" = Join-Path -Path $ProjectRoot -ChildPath "development\\managers\\mcp-manager\\scripts\\mcp-manager\.ps1"
        "NewDir" = Join-Path -Path $ProjectRoot -ChildPath "src\mcp\scripts\mcp-manager"
    }
    "ScriptManager" = @{
        "OldPath" = Join-Path -Path $ProjectRoot -ChildPath "development\\managers\\script-manager\\scripts\\script-manager\.ps1"
        "NewPath" = Join-Path -Path $ProjectRoot -ChildPath "development\\managers\\script-manager\\scripts\\script-manager\.ps1"
