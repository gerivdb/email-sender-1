...
$filesToMove = @{
    "integrated-manager" = @{
        "Scripts" = @(
            @{
                "Source" = Join-Path -Path $ProjectRoot -ChildPath "development\\managers\\integrated-manager\\scripts\\integrated-manager\.ps1"
                "Destination" = Join-Path -Path $managersRoot -ChildPath "integrated-manager\scripts\integrated-manager.ps1"
            },
            @{
                "Source" = Join-Path -Path $ProjectRoot -ChildPath "development\\managers\\integrated-manager\\scripts\\install-integrated-manager\.ps1"
    ...
    "mode-manager" = @{
        "Scripts" = @(
            @{
                "Source" = Join-Path -Path $ProjectRoot -ChildPath "development\\managers\\mode-manager\\scripts\\mode-manager\.ps1"
                "Destination" = Join-Path -Path $managersRoot -ChildPath "mode-manager\scripts\mode-manager.ps1"
            },
            @{
                "Source" = Join-Path -Path $ProjectRoot -ChildPath "development\\managers\\mode-manager\\scripts\\install-mode-manager\.ps1"
    ...
    "roadmap-manager" = @{
        "Scripts" = @(
            @{
                "Source" = Join-Path -Path $ProjectRoot -ChildPath "development\\managers\\roadmap-manager\\scripts\\roadmap-manager\.ps1"
    ...
    "mcp-manager" = @{
        "Scripts" = @(
            @{
                "Source" = Join-Path -Path $ProjectRoot -ChildPath "development\\managers\\mcp-manager\\scripts\\mcp-manager\.ps1"
    ...
    "script-manager" = @{
        "Scripts" = @(
            @{
                "Source" = Join-Path -Path $ProjectRoot -ChildPath "development\\managers\\script-manager\\scripts\\script-manager\.ps1"
    ...
    "n8n-manager" = @{
        "Scripts" = @(
            @{
                "Source" = Join-Path -Path $ProjectRoot -ChildPath "development\\managers\\n8n-manager\\scripts\\n8n-manager\.ps1"
                "Destination" = Join-Path -Path $managersRoot -ChildPath "n8n-manager\scripts\n8n-manager.ps1"
            }
        )
        "Config" = @(
            @{
                "Source" = Join-Path -Path $ProjectRoot -ChildPath "projet\\config\\managers\\n8n-manager\\n8n-manager\.config\.json"
