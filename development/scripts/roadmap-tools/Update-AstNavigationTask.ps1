# Script pour mettre Ã  jour la tÃ¢che principale de navigation dans l'arbre syntaxique
...
$taskIds = @(
    "2.1.2.4.1.2.3.2.2.5.3.2.2.1.3"      # TÃ¢che principale : DÃ©velopper des mÃ©thodes de navigation dans l'arbre syntaxique
)
