# Script pour mettre à jour la tâche principale de navigation dans l'arbre syntaxique
...
$taskIds = @(
    "2.1.2.4.1.2.3.2.2.5.3.2.2.1.3"      # Tâche principale : Développer des méthodes de navigation dans l'arbre syntaxique
)
