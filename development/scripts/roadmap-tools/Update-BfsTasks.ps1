# Script pour mettre à jour les tâches BFS dans la roadmap
...
$taskIds = @(
    "2.1.2.4.1.2.3.2.2.5.3.2.2.1.3.2",      # Tâche principale
    "2.1.2.4.1.2.3.2.2.5.3.2.2.1.3.2.1",    # Créer la structure de base avec une file d'attente pour le parcours
    "2.1.2.4.1.2.3.2.2.5.3.2.2.1.3.2.2",    # Implémenter la logique de parcours itératif des nœuds
    "2.1.2.4.1.2.3.2.2.5.3.2.2.1.3.2.3",    # Ajouter des options de filtrage par niveau de profondeur
    "2.1.2.4.1.2.3.2.2.5.3.2.2.1.3.2.4",    # Implémenter la gestion des erreurs et des cas limites
    "2.1.2.4.1.2.3.2.2.5.3.2.2.1.3.2.5"     # Optimiser la gestion de la mémoire pour les grands arbres
)
