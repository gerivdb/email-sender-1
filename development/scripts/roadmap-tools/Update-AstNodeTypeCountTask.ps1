# Script pour mettre à jour la tâche de comptage des noeuds dans la roadmap
...
$taskIds = @(
    "2.1.2.4.1.2.3.2.2.5.3.2.2.1.3.5.2"      # Développer une fonction pour compter les noeuds d'un certain type
)
