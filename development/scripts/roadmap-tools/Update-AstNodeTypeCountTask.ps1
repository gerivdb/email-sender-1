# Script pour mettre Ã  jour la tÃ¢che de comptage des noeuds dans la roadmap
...
$taskIds = @(
    "2.1.2.4.1.2.3.2.2.5.3.2.2.1.3.5.2"      # DÃ©velopper une fonction pour compter les noeuds d'un certain type
)
