# Script pour mettre à jour la tâche d'implémentation d'une fonction de parcours en profondeur (DFS) de l'AST
...
$taskIds = @(
    "2.1.2.4.1.2.3.2.2.5.3.2.2.1.3.1"      # Tâche : Implémenter une fonction de parcours en profondeur (DFS) de l'AST
)
