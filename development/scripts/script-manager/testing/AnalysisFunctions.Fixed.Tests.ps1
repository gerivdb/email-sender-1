...
<#
.SYNOPSIS
    Tests unitaires corrig̩s pour les fonctions d'analyse des scripts du manager.
.DESCRIPTION
    Ce script contient des tests unitaires corrig̩s pour les fonctions d'analyse
...
# Tests Pester
Describe "Tests des fonctions d'analyse des scripts du manager (version corrig̩e)" {
