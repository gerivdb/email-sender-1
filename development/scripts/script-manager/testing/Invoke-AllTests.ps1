...
.DESCRIPTION
    Ce script ex̩cute tous les tests unitaires et d'int̩gration du script manager,
...
.EXAMPLE
    .\Invoke-AllTests.ps1 -OutputPath ".\reports\tests" -GenerateHTML
.EXAMPLE
    .\Invoke-AllTests.ps1 -TestName "OrganizationFunctions"
.NOTES
    Version: 1.0.0
...
if ($GenerateHTML) {
    ...
    Write-Log "G̩n̩ration d'un rapport HTML simple..." -Level "INFO"
