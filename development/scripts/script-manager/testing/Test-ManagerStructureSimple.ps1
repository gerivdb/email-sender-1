...
<#
.SYNOPSIS
    Tests simplifi̩s de la structure du dossier manager.
.DESCRIPTION
    Ce script contient des tests simplifi̩s pour v̩rifier la structure du dossier manager,
...
# Tests Pester
Describe "Tests simplifi̩s de la structure du dossier manager" {
...
<html>
<head>
    <title>Rapport de tests de structure simplifi̩s</title>
    <style>
...
<body>
    <h1>Rapport de tests de structure simplifi̩s</h1>
