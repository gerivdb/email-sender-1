...
<#
.SYNOPSIS
    HygenExtensionModule module (Extension).
.DESCRIPTION
...
$script:ModuleName = 'HygenExtensionModule'
...
function Initialize-HygenExtensionModuleModule {
    <#
    .SYNOPSIS
        Initialise le module HygenExtensionModule.
    .DESCRIPTION
        Crée les dossiers nécessaires et initialise les configurations du module.
    .EXAMPLE
        Initialize-HygenExtensionModuleModule
    #>
    [CmdletBinding(SupportsShouldProcess = $true)]
    param()
