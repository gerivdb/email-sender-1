@{
    ...
    GUID = 'd0fec7d5-bea2-46a9-9e3e-00fc2c4acbd0'
    ...
    Description = 'Module d'extension de test pour Hygen'
    ...
    PrivateData = @{
        PSData = @{
            ...
            Tags = @('HygenExtensionModule', 'PowerShell', 'testing')
            ...
            ReleaseNotes = 'Version initiale du module HygenExtensionModule.'
        }
    }
