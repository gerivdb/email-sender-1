@{
    ...
    GUID = '9061a762-0e44-4660-babf-86ac412cba1c'
    ...
    Description = 'Module de test pour Hygen 2'
    ...
    PrivateData = @{
        PSData = @{
            ...
            Tags = @('HygenTestModule2', 'PowerShell', 'testing')
            ...
            ReleaseNotes = 'Version initiale du module HygenTestModule2.'
        }
    }
