...
$script:ModuleName = 'HygenTestModule2'
...
function Initialize-HygenTestModule2Module {
    <#
    .SYNOPSIS
        Initialise le module HygenTestModule2.
    .DESCRIPTION
        Crée les dossiers nécessaires et initialise les configurations du module.
    .EXAMPLE
        Initialize-HygenTestModule2Module
    #>
