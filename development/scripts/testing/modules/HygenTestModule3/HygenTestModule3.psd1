@{
    ...
    GUID = '4f0db939-99b8-4797-8637-51f6cab8851e'
    ...
    Description = 'Module de test pour Hygen 3'
    ...
    PrivateData = @{
        PSData = @{
            ...
            Tags = @('HygenTestModule3', 'PowerShell', 'testing')
            ...
            ReleaseNotes = 'Version initiale du module HygenTestModule3.'
        }
    }
