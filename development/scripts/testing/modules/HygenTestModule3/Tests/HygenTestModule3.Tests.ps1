...
<#
.SYNOPSIS
    Tests pour le module HygenTestModule3.
.DESCRIPTION
    Ce script contient des tests Pester pour le module HygenTestModule3.
.EXAMPLE
    Invoke-Pester -Path ".\HygenTestModule3.Tests.ps1"
.NOTES
    Version: 1.0.0
...
Describe "HygenTestModule3 Module Tests" {
    Context "Module Loading" {
        ...
        It "Should have exported functions" {
            $ExportedFunctions = Get-Command -Module HygenTestModule3 -CommandType Function
...
AfterAll {
    ...
    Remove-Module -Name HygenTestModule3 -ErrorAction SilentlyContinue
}
