@{
    ...
    GUID = '0de2279c-3b17-434e-93ac-ae1ad21a5591'
    ...
    Description = 'Module avancé de test pour Hygen'
    ...
    PrivateData = @{
        PSData = @{
            ...
            Tags = @('HygenAdvancedModule', 'PowerShell', 'testing')
            ...
            ReleaseNotes = 'Version initiale du module HygenAdvancedModule.'
        }
    }
