...
<#
.SYNOPSIS
    HygenAdvancedModule module (Advanced).
.DESCRIPTION
...
$script:ModuleName = 'HygenAdvancedModule'
...
function Initialize-HygenAdvancedModuleModule {
    <#
    .SYNOPSIS
        Initialise le module HygenAdvancedModule.
    .DESCRIPTION
        Crée les dossiers nécessaires et initialise les configurations du module.
    .EXAMPLE
        Initialize-HygenAdvancedModuleModule
    #>
    [CmdletBinding(SupportsShouldProcess = $true)]
    param()
