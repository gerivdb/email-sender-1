...
<#
.SYNOPSIS
    Test Advanced Module (Advanced).
.DESCRIPTION
    Module PowerShell avancé pour les tests.
    Ce module avancé inclut une gestion d'état complète.
.EXAMPLE
    Import-Module TestAdvancedModule
    Get-Command -Module TestAdvancedModule
.NOTES
    Version: 1.0.0
    Auteur: Test User
...
$script:ModuleName = 'TestAdvancedModule'
...
function Initialize-TestAdvancedModule {
    <#
    .SYNOPSIS
        Initialise le module Test Advanced Module.
    .DESCRIPTION
        Crée les dossiers nécessaires et initialise les configurations du module.
    .EXAMPLE
        Initialize-TestAdvancedModule
    #>
    [CmdletBinding(SupportsShouldProcess = $true)]
    param()
