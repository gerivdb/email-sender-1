@{
    ...
    Description = 'Module PowerShell avancé pour les tests avec gestion d''état'
    ...
    PrivateData = @{
        PSData = @{
            ...
            Tags = @('TestAdvancedModule', 'PowerShell', 'testing')
            
            # Notes de publication de ce module
            ReleaseNotes = 'Version initiale du module TestAdvancedModule.'
        }
    }
}
