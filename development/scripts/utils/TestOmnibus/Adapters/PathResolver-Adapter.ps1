<#
.SYNOPSIS
    Adaptateur TestOmnibus pour les tests de rÃƒÂ©solution de chemins.
.DESCRIPTION
    Cet adaptateur permet d'exÃƒÂ©cuter les tests de rÃƒÂ©solution de chemins
...
function Invoke-PathResolverTests {
    ...
    Write-Host "ExÃƒÂ©cution des tests de rÃƒÂ©solution de chemins..." -ForegroundColor Cyan
...
<head>
    <meta charset="UTF-8">
    <title>Rapport de tests - RÃƒÂ©solution de chemins</title>
    <style>
...
<body>
    <h1>Rapport de tests - RÃƒÂ©solution de chemins</h1>
