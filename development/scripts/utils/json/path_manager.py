...
if __name__ == "__main__":
    ...
    print(f"Chemin absolu de 'development/scripts/utils': {get_project_path('development/scripts/utils')}")
    print(f"Chemin relatif de '{path_manager.project_root}/development/scripts/utils': {get_relative_path(path_manager.project_root / 'scripts' / 'utils')}")
    print(f"Normalisation de 'development/scripts/utils': {normalize_path('development/scripts/utils')}")
    print(f"Normalisation de 'scripts\\utils': {normalize_path('scripts\\utils')}")
    print(f"Normalisation de 'development/scripts/utils' (style Windows): {normalize_path('development/scripts/utils', force_windows_style=True)}")
    print(f"Normalisation de 'scripts\\utils' (style Unix): {normalize_path('scripts\\utils', force_unix_style=True)}")
    print(f"Suppression des accents de 'development/scripts/utilitès': {remove_path_accents('development/scripts/utilitès')}")
    print(f"Remplacement des espaces de 'development/scripts/utils test': {replace_path_spaces('development/scripts/utils test')}")
    print(f"Normalisation complète de 'development/scripts/utilitès test': {normalize_path_full('development/scripts/utilitès test')}")
    print(f"'development/scripts/utilitès' contient des accents: {has_path_accents('development/scripts/utilitès')}")
    print(f"'development/scripts/utils test' contient des espaces: {has_path_spaces('development/scripts/utils test')}")
