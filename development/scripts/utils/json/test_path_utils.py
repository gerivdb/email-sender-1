...
class TestPathManager(unittest.TestCase):
    ...
    def test_get_project_path(self):
        ...
        relative_path = "development/scripts/utils/path-utils.ps1"
    ...
    def test_get_relative_path(self):
        ...
        self.assertEqual(relative_path, "development/scripts/utils/path-utils.ps1")
    ...
    def test_normalize_path(self):
        ...
        self.assertEqual(normalized_path, "..\..\D")
        
        # Test avec force_unix_style
        normalized_path = self.path_manager.normalize_path(path, force_unix_style=True)
        self.assertEqual(normalized_path, "development/scripts/utils/path-utils.ps1")
    
    def test_remove_path_accents(self):
        """Test de la méthode remove_path_accents."""
        path = "development/scripts/utilitès/path-utils.ps1"
        path_without_accents = self.path_manager.remove_path_accents(path)
        self.assertEqual(path_without_accents, "development/scripts/utilites/path-utils.ps1")
    ...
    def test_replace_path_spaces(self):
        ...
        self.assertEqual(path_without_spaces, "development/scripts/utils_test/path-utils.ps1")
    
    def test_normalize_path_full(self):
        """Test de la méthode normalize_path_full."""
        path = "development/scripts/utilitès test/path-utils.ps1"
    ...
    def test_has_path_accents(self):
        ...
        path_with_accents = "development/scripts/utilitès/path-utils.ps1"
        path_without_accents = "development/scripts/utilities/path-utils.ps1"
    ...
    def test_has_path_spaces(self):
        ...
        path_with_spaces = "development/scripts/utils test/path-utils.ps1"
        path_without_spaces = "development/scripts/utils_test/path-utils.ps1"
