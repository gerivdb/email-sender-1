...
.DESCRIPTION
    Ce script contient des tests unitaires pour le module ModuleDependencyAnalyzer,
...
$moduleName = "ModuleDependencyAnalyzer"
...
Describe "ModuleDependencyAnalyzer Tests" {
    BeforeAll {
        # Importer le module à tester
