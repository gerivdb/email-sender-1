...
<#
.SYNOPSIS
    Tests simples pour le module ModuleDependencyAnalyzer.

.DESCRIPTION
    Ce script contient des tests simples pour le module ModuleDependencyAnalyzer.
...
$moduleName = "ModuleDependencyAnalyzer-New"
