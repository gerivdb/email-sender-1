...
$modulePath = Join-Path -Path $moduleRoot -ChildPath "ModuleDependencyAnalyzer_Fixed.psm1"

if (-not (Test-Path -Path $modulePath)) {
    throw "Le module ModuleDependencyAnalyzer_Fixed.psm1 n'existe pas dans le chemin sp̩cifi̩: $modulePath"
}
...
Write-Host "D̩pendances trouv̩es: $($dependencies.Count)" -ForegroundColor Yellow
