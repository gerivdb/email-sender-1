# Script pour exÃ©cuter uniquement les tests du module ModuleDependencyAnalyzer-Fixed
# Ce script exÃ©cute tous les tests unitaires du module ModuleDependencyAnalyzer-Fixed
...
Write-Host "Nombre de tests Ã  exÃ©cuter: $($testScripts.Count)" -ForegroundColor $infoColor
