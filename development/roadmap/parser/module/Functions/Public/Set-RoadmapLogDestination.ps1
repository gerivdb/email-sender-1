...
.DESCRIPTION
    ...
    Elle permet de dÃ©finir oÃ¹ les messages de journal seront Ã©crits.
...
.EXAMPLE
    ...
    Configure la journalisation pour Ã©crire les messages dans la console.

.EXAMPLE
    Set-RoadmapLogDestination -Destination File -FilePath "C:\Logs\RoadmapParser.log"
    Configure la journalisation pour Ã©crire les messages dans un fichier.

.EXAMPLE
    Set-RoadmapLogDestination -Destination Both -FilePath "C:\Logs\RoadmapParser.log" -FileMaxSize 5MB -FileMaxCount 3
    Configure la journalisation pour Ã©crire les messages dans la console et dans un fichier, avec une taille maximale de 5MB et en conservant 3 fichiers.
...
function Set-RoadmapLogDestination {
    ...
    # Mettre Ã  jour la destination de journalisation
