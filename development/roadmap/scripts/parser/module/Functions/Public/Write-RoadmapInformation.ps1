<#
.SYNOPSIS
    Ã‰crit un message d'information dans le journal du module RoadmapParser.

.DESCRIPTION
    La fonction Write-RoadmapInformation Ã©crit un message d'information dans le journal du module RoadmapParser.
