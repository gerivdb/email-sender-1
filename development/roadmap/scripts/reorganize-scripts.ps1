<#
.SYNOPSIS
    RÃƒÂ©organise les scripts de roadmap dans la nouvelle structure de dossiers.

.DESCRIPTION
    Ce script dÃƒÂ©place les fichiers existants dans le dossier development/roadmap/scripts vers la nouvelle structure
