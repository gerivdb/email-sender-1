...
Si vous souhaitez personnaliser les templates existants ou en créer de nouveaux, vous pouvez modifier les fichiers dans le dossier `n8n/development/templates`.
...
- Que les templates sont présents dans le dossier `n8n/development/templates`
