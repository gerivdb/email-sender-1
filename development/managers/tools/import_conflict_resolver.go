...
// ImportConflictResolver implémente l'interface ToolkitOperation pour résoudre les conflits d'imports
...
func NewImportConflictResolver(baseDir string, logger *Logger, dryRun bool) (*ImportConflictResolver, error) {
	if baseDir == "" {
