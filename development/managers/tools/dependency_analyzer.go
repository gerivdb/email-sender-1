...
// DependencyAnalyzer implémente l'interface ToolkitOperation pour l'analyse des dépendances
...
func NewDependencyAnalyzer(baseDir string, logger *Logger, dryRun bool) (*DependencyAnalyzer, error) {
	if baseDir == "" {
