...
// DuplicateTypeDetector implémente l'interface ToolkitOperation pour la détection des types dupliqués
...
func NewDuplicateTypeDetector(baseDir string, logger *Logger, dryRun bool) (*DuplicateTypeDetector, error) {
	if baseDir == "" {
