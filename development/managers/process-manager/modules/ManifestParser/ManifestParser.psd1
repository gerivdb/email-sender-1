@{
    ...
    Description = 'Module de parsing de manifestes pour le Process Manager.'
    ...
    PrivateData = @{
        PSData = @{
            ...
            Tags = @('ProcessManager', 'Manifest', 'Parser')
            ...
            ReleaseNotes = 'Version initiale du module ManifestParser.'
        }
    }
}
