...
| CompÃ©tence | Occurrences | Pourcentage |
|------------|-------------|-------------|
| PowerShell | 24 | 17% |
...
### <a name='journalisation'></a>Journalisation
...
### <a name='tests-de-performance'></a>Tests de performance
...
### <a name='gestion-d'ã©tats'></a>Gestion d'Ã©tats
