...
"""
Script pour exécuter tous les tests Langchain.
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Exécuter les tests Langchain')
    parser.add_argument('--pattern', default='test_*.py', help='Pattern pour filtrer les fichiers de test')
    parser.add_argument('--test', help='Nom spécifique du test à exécuter (ex: test_cache.TestCacheManager)')
